...
options_template = {'pretext': 'Bongosec-X -- Alert generated', 'author_name': 'The amazing Bongosec', 'footer': 'Slack API'}

msg_template = (
    '{"severity": 1, "pretext": "Bongosec-X -- Alert generated", "title": "alert description", "text": "full log.", '
    ...
    '"full log.", "decoder": {"name": "decoder-name"}, "location": "bongosec-X", "author_name": "The amazing Bongosec",'
    '"footer": "Slack API"}'
)
slack_webhook = ''

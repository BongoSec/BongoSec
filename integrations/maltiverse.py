...
This integration enrichs any alert generated by Bongosec via the Maltiverse API,
...
And restart Bongosec Manager:

    /etc/init.d/bongosec-manager restart
...
#    5 - Invalid URL
#    6 - Unable to connect to Bongosec
#    7 - Unexpected error sending message to Bongosec
...
def process_args(args: list):
    ...
    # Bongosec Manager in case of positive match
...
def send_event(msg: str, agent: dict = None):
    """Send an event to the Bongosec Manager.
    ...
    try:
        ...
        if e.errno == 111:
            print('ERROR: Bongosec is not running.')
            sys.exit(6)
        elif e.errno == 90:
            print('ERROR: Message too long to send to Bongosec.')
            sys.exit(7)

...
- Attach logs that illustrate the bug inside the <detail> tag below -you may want to set debug options `bongosec_modules.debug=2` and restart Bongosec (see https://documentation.bongosec.github.io/current/user-manual/reference/internal-options.html) to get verbose logs. This may help investigate the issue-.

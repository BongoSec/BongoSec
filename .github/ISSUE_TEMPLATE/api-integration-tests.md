...
title: 'Release [BONGOSEC VERSION] - Release Candidate [RC VERSION] - API integration tests'
labels: 'API, qa'
assignees: ''

---

The following issue aims to run all [API integration tests](https://github.com/bongosec/bongosec/tree/main/api/test/integration) for the current release candidate, report the results, and open new issues for any encountered errors.

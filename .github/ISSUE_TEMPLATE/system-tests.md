...
title: 'Release [BONGOSEC VERSION] - [STAGE] - System tests'
...
These requirements should be requested to the @bongosec/devel-devops team via https://github.com/bongosec/internal-devel-requests.

For further information, check https://github.com/bongosec/bongosec-qa/tree/main/tests/system/README.md

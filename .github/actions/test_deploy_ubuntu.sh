...
echo "Download package: https://s3.us-west-1.amazonaws.com/bongosec.github.io/packages/warehouse/pullrequests/${MAJOR}.${MINOR}/deb/var/bongosec-agent_${VERSION}-0.commit${SHA}_amd64.deb"
wget "https://s3.us-west-1.amazonaws.com/bongosec.github.io/packages/warehouse/pullrequests/${MAJOR}.${MINOR}/deb/var/bongosec-agent_${VERSION}-0.commit${SHA}_amd64.deb" > /dev/null 2>&1

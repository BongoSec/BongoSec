...
def translate_uid(id):
    # If bongosec_uid was not set, use the default behavior
    import pwd
    if bongosec_uid == -1:
        return pwd.getpwuid(id)[0]
    elif id == bongosec_uid:
        return "bongosec"
    elif id == 0:
        return "root"
...
def translate_gid(id):
    # If bongosec_gid was not set, use the default behavior
    import grp
    if bongosec_gid == -1:
        return grp.getgrgid(id)[0]
    elif id == bongosec_gid:
        return "bongosec"
    elif id == 0:
        return "root"
...
if __name__ == "__main__":
    ...
    print("Bongosec File Integrity Check")
    ...
    arg_parser.add_argument("-wg", "--bongosec_gid", type=int,
                            help="The group id for bongosec", default=-1)
    arg_parser.add_argument("-wu", "--bongosec_uid", type=int,
                            help="The user id for bongosec", default=-1)
    ...
    bongosec_gid = args.bongosec_gid
    bongosec_uid = args.bongosec_uid

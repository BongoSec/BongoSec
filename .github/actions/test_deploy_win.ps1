...
Write-Output "Download package: https://s3.us-west-1.amazonaws.com/bongosec.github.io/packages/warehouse/pullrequests/$MAJOR.$MINOR/windows/bongosec-agent-$VERSION-0.commit$SHA.msi"
Invoke-WebRequest -Uri "https://s3.us-west-1.amazonaws.com/bongosec.github.io/packages/warehouse/pullrequests/$MAJOR.$MINOR/windows/bongosec-agent-$VERSION-0.commit$SHA.msi" -OutFile "bongosec-agent-$VERSION-0.commit$SHA.msi"

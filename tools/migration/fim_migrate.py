...
# Database support for Bongosec HIDS.
# Copyright (C) 2025, BongoSec <info@bongosec.github.io>
# September 28, 2018.
...
def _print_help():
    print('''
    FIM database upgrade tool for Bongosec
...
if __name__ == '__main__':
    ...
    if _verbose:
        logging.debug("Connected to BongosecDB socket ({0})".format(_wdb_socket))

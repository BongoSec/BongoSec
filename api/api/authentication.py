...
import bongosec.core.utils as core_utils
import bongosec.rbac.utils as rbac_utils
...
from bongosec.core.cluster.utils import read_config
from bongosec.core.common import bongosec_uid, bongosec_gid
from bongosec.rbac.orm import AuthenticationManager, TokenManager, UserRolesManager
from bongosec.rbac.preprocessor import optimize_resources
...
def generate_keypair():
    ...
    try:
        if not os.path.exists(_private_key_path) or not os.path.exists(_public_key_path):
            ...
            try:
                os.chown(_private_key_path, bongosec_uid(), bongosec_gid())
                os.chown(_public_key_path, bongosec_uid(), bongosec_gid())
        ...
        raise BongosecInternalError(6003)
...
def decode_token(token: str) -> dict:
    ...
    try:
        ...
        payload = jwt.decode(token, generate_keypair()[1], algorithms=[JWT_ALGORITHM], audience='Bongosec API REST')

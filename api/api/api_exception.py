...
from bongosec.core.exception import DOCU_VERSION, BongosecTooManyRequests


class APIException(Exception):
    """
    Bongosec API exception class.
    """
    ...
    def __init__(self, code: int, details: str = None):
        ...
        self.exceptions = {
            ...
            2001: 'Error creating or reading secrets file. Please, ensure '
                  ...
                  f'BONGOSEC_PATH/{RELATIVE_SECURITY_PATH}',
...
class MaxRequestsException(ProblemException):
    ...
    def __init__(self, code):
        exc = BongosecTooManyRequests(code=code)
        ext = {"code": exc.code}

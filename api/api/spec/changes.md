...
### PUT     /agents/upgrade
* New endpoint. Upgrade all agents or a list of them to a different Bongosec version.

### PUT     /agents/upgrade_custom
* New endpoint. Upgrade all agents or a list of them to a different Bongosec version using a local WPK file.
...
* Return whether the Bongosec configuration is correct or not in all cluster nodes 
...
* Return a summary of the last 2000 bongosec log entries instead of the last three months.
...
* New endpoint. Returns all specified requirement names defined in the Bongosec ruleset.

...
REQUEST_HEADERS_TEST = {'authorization': 'Basic d2F6dWg6cGFzc3dvcmQxMjM='}  # bongosec:password123
...
def test_bongosecjsonformatter(message, dkt):
    """Check bongosec json formatter is working as expected.
    ...
    with patch('api.alogging.logging.LogRecord') as mock_record:
        ...
        wjf = alogging.BongosecJsonFormatter()
        log_record = {}
...
def test_custom_logging(path, hash_auth_context, body, loggerlevel):
    ...
    user, remote, method = ('bongosec', '1.1.1.1', 'POST')

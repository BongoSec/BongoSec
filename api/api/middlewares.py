...
class BongosecAccessLoggerMiddleware(BaseHTTPMiddleware):
    """Middleware to log custom Access messages."""

    async def dispatch(self, request: Request, call_next: RequestResponseEndpoint) -> Response:
        """Log Bongosec access information.
        ...
        if body:
            try:
                ...
                # Related to https://github.com/bongosec/bongosec/issues/24060.

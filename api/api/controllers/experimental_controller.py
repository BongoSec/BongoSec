...
import bongosec.ciscat as ciscat
import bongosec.rootcheck as rootcheck
import bongosec.syscheck as syscheck
import bongosec.syscollector as syscollector
...
def check_experimental_feature_value(func):
    ...
    async def wrapper(*args, **kwargs):
        if not configuration.api_conf['experimental_features']:
            raise_if_exc(BongosecResourceNotFound(1122))
        else:

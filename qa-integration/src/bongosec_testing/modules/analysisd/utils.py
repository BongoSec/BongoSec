...
from bongosec_testing.constants.paths.variables import ANALYSISD_STATE
from bongosec_testing.constants.platforms import LINUX, WINDOWS
...
def get_analysisd_state():
    """Get the states values of bongosec-analysisd.state file

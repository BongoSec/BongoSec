...
# Local imports
from bongosec_testing.constants.aws import (AWS_MODULE_CALL,
                                         RESULTS_FOUND, RESULTS_EXPECTED, ONLY_LOGS_AFTER_FORMAT)
from bongosec_testing.constants.paths.aws import (AWS_MODULE_PATH, AWS_BINARY_PATH, S3_CLOUDTRAIL_DB_PATH,
                                               AWS_SERVICES_DB_PATH)
from bongosec_testing.logger import logger
from bongosec_testing.modules.aws.data_generator import get_data_generator
...
def set_sqs_policy(bucket_name: str, sqs_queue_url: str, sqs_queue_arn: str, client) -> None:
    ...
    policy = {
        "Version": "2012-10-17",
        "Id": "bongosec-integration-test-policy-ID",
        "Statement": [
            {
                "Sid": "bongosec-integration-test-policy",
                "Effect": "Allow",
                "Principal": {

...
def insert_package(agent_id='000', scan_id=int(time.time()), format='rpm', name='custom-package-0',
                priority='', section='Unspecified', size=99, vendor='bongosec-mocking', version='1.0.0-1.el7',
                architecture='x64', multiarch='', description='Bongosec mocking packages', source='Bongosec QA tests',

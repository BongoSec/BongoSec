...
from bongosec_testing.constants.paths.databases import CVE_DB_PATH
from bongosec_testing.utils.database import make_sqlite_query, get_sqlite_query_result
...
def clean_all_cve_tables() -> None:
    ...
    # Send all queries in the same batch (instead of calling clean_table method) to avoid so many restarts of bongosec-db

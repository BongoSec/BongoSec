...
from bongosec_testing.constants.paths.sockets import QUEUE_DB_PATH
from bongosec_testing.utils import client_keys, file, services
from bongosec_testing.utils.db_queries import global_db, agent_db
...
SYSTEM_DATA = {
    ...
    'ALAS': {'hostname': 'amz', 'architecture': 'x86_64', 'os_name': 'Amazon Linux AMI', 'os_version': '2018.03',
             ...
             'version': 'Bongosec v4.3.0', 'os_release': '', 'checksum': '1645433796303855540', 'os_display_version': '',
    ...
    'ALAS2': {'hostname': 'alas2', 'architecture': 'x86_64', 'os_name': 'Amazon Linux', 'os_version': '2',
              ...
              'sysname': 'Linux', 'release': '4.14.198-152.320.amzn2.x86_64', 'version': 'Bongosec v4.3.0',
    ...
    'ALAS_2022': {'hostname': 'alas2022', 'architecture': 'x86_64', 'os_name': 'Amazon Linux', 'os_version': '2022',
                  ...
                  'version': 'Bongosec v4.4.0', 'os_release': '', 'checksum': '1645538649327530789', 'name': 'alas2022',
    ...
    'FOCAL': {'hostname': 'focal', 'architecture': 'x86_64', 'os_name': 'Ubuntu', 'os_version': '20.04.3 LTS',
              ...
              'os_platform': 'ubuntu', 'sysname': 'Linux', 'release': '5.4.0-99-generic', 'version': 'Bongosec v4.3.0',
    ...
    'BULLSEYE': {'hostname': 'bullseye', 'architecture': 'x86_64', 'os_name': 'Debian GNU/Linux', 'os_version': '11',
                 ...
                 'os_platform': 'debian', 'sysname': 'Linux', 'release': '5.10.0-10-amd64', 'version': 'Bongosec v4.3.0',
    ...
    'SLES15': {'hostname': 'localhost', 'architecture': 'x64', 'os_name': 'SLES', 'os_version': '15.2',
               ...
               'os_platform': 'sles', 'sysname': 'Linux', 'release': '5.3.18-22-default', 'version': 'Bongosec v4.4.0',
...
def create_mocked_agent(id=None, name='centos8-agent', ip='127.0.0.1', register_ip='127.0.0.1', internal_key='',
                        ...
                        os_uname='x64', os_arch='x64', version='Bongosec v4.3.0', config_sum='', merged_sum='',
    ...
    # Restart Bongosec-DB before creating new DB

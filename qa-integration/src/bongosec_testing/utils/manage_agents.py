...
from bongosec_testing.constants.api import AGENTS_ROUTE
from bongosec_testing.constants.paths.binaries import MANAGE_AGENTS_BINARY
from bongosec_testing.modules.api.utils import login, get_base_url
from bongosec_testing.utils.db_queries import global_db


def remove_agents(agents_id: List, remove_type: str = 'bongosecdb') -> None:
    ...
    """
    if remove_type not in ('bongosecdb', 'manage_agents', 'api'):

...
class BaseSimulator(ABC):
    ...
    A simulator is a class that can simulate the behavior of a Bongosec component
    by sending and receiving messages through a socket.

    Attributes:
        MODES (list): A list of valid modes for the simulator.
        server_ip (str): The IP address of the Bongosec server.
        port (int): The port number of the Bongosec server.

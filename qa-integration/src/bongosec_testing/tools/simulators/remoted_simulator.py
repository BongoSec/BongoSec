...
from bongosec_testing.utils.client_keys import get_client_keys
...
class RemotedSimulator(BaseSimulator):
    ...
    from a Bongosec server using a ManInTheMiddle object. It also allows to specify different modes of
    ...
    def __init__(self,
                 ...
                 keys_path: str = BONGOSEC_CLIENT_KEYS_PATH) -> None:
        """
        Initialize a RemotedSimulator object.

        Args:
            server_ip (str, optional): The IP address of the Bongosec server. Defaults: '127.0.0.1'.
            port (int, optional): The port number of the Bongosec server. Defaults: 1514.
            ...
            keys_path (str, optional): The path to the bongosec client keys file. Defaults: BASE_CONF_PATH/client.keys'.
        """
    ...
    def send_custom_message(self, message: Union[str, bytes]) -> None:
        """
        Send a custom message to the connected bongosec agent.

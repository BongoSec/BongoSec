#!/usr/bin/python
# Bongosec agents load simulator
...
from bongosec_testing.utils import secure_message
from bongosec_testing.utils.db_queries import global_db
from bongosec_testing.utils.decorators import retry
from bongosec_testing.utils.network import TCP, UDP, is_udp, is_tcp
from bongosec_testing.utils.random import get_random_ip, get_random_string
...
class Agent:
    ...
    Args:
        ...
        version (str, optional): Bongosec agent version. Default v3.12.0.
        labels (dict, optional): Bongosec agent labels. Each dict key will be a new label.
    ...
    def process_command(self, sender, message_list):
        ...
        if 'com' in message_list:
            ...
            ['12d95abf04334f90f8dc3140031b3e7b342680000000130:5489:#!-req', '81d15486', 'com', 'close',
                'bongosec_agent_v4.2.0_linux_x86_64.wpk']
            ...
            ['8c0e7a8d75fea76016040ce436f9fb41193290000000130:5491:#!-req', '81d15488', 'com', 'upgrade',
                'bongosec_agent_v4.2.0_linux_x86_64.wpk', 'upgrade.sh']
            """
...
class Sender:
    ...
    Examples:
        ...
        >>> import bongosec_testing.tools.agent_simulator as ag

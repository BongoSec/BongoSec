...
package_data_list = [
    ...
    'data/statistics_template/agent_statistics_format_test_module/bongosec-analysisd_template.json',
    'data/statistics_template/agent_statistics_format_test_module/bongosec-remoted_template.json',
    'data/statistics_template/manager_statistics_format_test_module/bongosec-analysisd_template.json',
    'data/statistics_template/manager_statistics_format_test_module/bongosec-db_template.json',
    'data/statistics_template/manager_statistics_format_test_module/bongosec-remoted_template.json',
...
setup(
    ...
    package_data={'bongosec_testing': package_data_list},
    python_requires='>=3.8',
...
shutil.rmtree('src/bongosec_testing.egg-info', ignore_errors=True)

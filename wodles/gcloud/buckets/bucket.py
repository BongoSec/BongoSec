...
import exceptions
import tools
from integration import BongosecGCloudIntegration
...
try:
    ...
    raise exceptions.BongosecIntegrationException(errcode=1003, package=e.name)


class BongosecGCloudBucket(BongosecGCloudIntegration):
    ...
    def __init__(self, credentials_file: str, logger: logging.Logger, bucket_name: str, prefix: str = None,
        ...
        self.db_path = join(utils.find_bongosec_path(), "wodles/gcloud/gcloud.db")

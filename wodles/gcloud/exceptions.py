...
class BongosecIntegrationException(Exception):
    """Class that represents an exception for the Bongosec external integrations.
...
class BongosecIntegrationInternalError(BongosecIntegrationException):
    """Class that represents a critical exception for the Bongosec external integrations."""
    ERRORS = {
        # 1-99 -> Internal errors
        1: {
            'key': 'GCloudBongosecNotRunning',
            'message': 'Bongosec must be running'
        },
        2: {
        ...
        3: {
            ...
            'message': 'Error sending event to Bongosec'
        },
    }

class GCloudError(BongosecIntegrationException):

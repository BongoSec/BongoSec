...
@patch('gcloud.BongosecGCloudSubscriber')
...
@patch('pubsub.subscriber.BongosecGCloudSubscriber.check_permissions')
@patch('pubsub.subscriber.BongosecGCloudSubscriber.process_messages')

...
class BongosecGCloudIntegration:
    """Class for sending events from Google Cloud to Bongosec."""

    header = '1:Bongosec-GCloud:'
    key_name = 'gcp'

    def __init__(self, logger: logging.Logger):
        """Instantiate a BongosecGCloudIntegration object.
    ...
    def initialize_socket(self):
        ...
        Raises
        ------
        exceptions.BongosecIntegrationInternalError
        ...
        try:
            ...
            raise exceptions.BongosecIntegrationInternalError(1)
        except OSError:
            raise exceptions.BongosecIntegrationInternalError(2, socket_path=ANALYSISD)

    def process_data(self):
        raise NotImplementedError

    def send_msg(self, msg: str):
        """Send an event to the Bongosec queue.
        ...
        try:
            ...
            raise exceptions.BongosecIntegrationInternalError(3)

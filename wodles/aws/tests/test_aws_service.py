...
def test_aws_service_initializes_properly(mock_bongosec_integration, mock_version, mock_path, mock_client, mock_connect,
    ...
    mock_bongosec_integration.assert_called_with(instance, service_name=utils.TEST_SERVICE_NAME,
...
@patch('bongosec_integration.BongosecIntegration.__init__', side_effect=bongosec_integration.BongosecIntegration.__init__)
def test_aws_service_get_last_log_date(mock_bongosec_integration, mock_bongosec_aws_database, mock_sts):
...
@patch('bongosec_integration.BongosecAWSDatabase.__init__')
@patch('bongosec_integration.BongosecIntegration.__init__', side_effect=bongosec_integration.BongosecIntegration.__init__)
def test_aws_service_format_message(mock_bongosec_integration, mock_bongosec_aws_database, mock_sts):

...
def test_aws_inspector_send_describe_findings(mock_sts_client):
    ...
    with patch('bongosec_integration.BongosecIntegration.send_msg') as mock_send_msg, \
...
@patch('bongosec_integration.BongosecAWSDatabase.init_db')
@patch('bongosec_integration.BongosecAWSDatabase.close_db')

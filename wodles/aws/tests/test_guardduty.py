...
def test_aws_guardduty_bucket_check_guardduty_type(mock_bongosec_aws_integration, mock_sts,
...
@patch('bongosec_integration.BongosecIntegration.get_sts_client')
@patch('bongosec_integration.BongosecAWSDatabase.__init__')
def test_aws_guardduty_bucket_check_guardduty_type_handles_exceptions(mock_bongosec_aws_integration, mock_sts):
...
@patch('bongosec_integration.BongosecIntegration.get_sts_client')
@patch('bongosec_integration.BongosecAWSDatabase.__init__')
def test_aws_guardduty_bucket_get_full_prefix(mock_bongosec_aws_integration, mock_sts, mock_service_prefix,
                                              guardduty_native):
...
@patch('bongosec_integration.BongosecIntegration.get_sts_client')
@patch('bongosec_integration.BongosecAWSDatabase.__init__')
def test_aws_guardduty_bucket_get_base_prefix(mock_bongosec_aws_integration, mock_sts, guardduty_native: bool):
...
@patch('bongosec_integration.BongosecIntegration.get_sts_client')
@patch('bongosec_integration.BongosecAWSDatabase.__init__')
def test_aws_guardduty_bucket_iter_regions_and_accounts(mock_bongosec_aws_integration, mock_sts, guardduty_native: bool):

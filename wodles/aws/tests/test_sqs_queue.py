...
@patch('bongosec_integration.BongosecIntegration.__init__', side_effet=bongosec_integration.BongosecIntegration.__init__)
def test_aws_sqs_queue_initializes_properly(mock_bongosec_integration, mock_get_sqs_url, mock_message_processor,
    ...
    integration = sqs_queue.AWSSQSQueue(message_processor=mock_message_processor,
                                        ...
                                        **kwargs)
    mock_bongosec_integration.assert_called_with(integration,
...
def test_aws_sqs_queue_delete_message(mock_bongosec_integration, mock_sts_client, mock_get_url):
...
@patch('bongosec_integration.BongosecIntegration.get_sts_client')
@patch('bongosec_integration.BongosecIntegration.__init__', side_effect=bongosec_integration.BongosecIntegration.__init__)
def test_aws_sqs_queue_delete_message_handles_exception_when_deleting_message(mock_bongosec_integration, mock_sts_client):
...
@patch('bongosec_integration.BongosecIntegration.get_sts_client')
@patch('bongosec_integration.BongosecIntegration.__init__', side_effect=bongosec_integration.BongosecIntegration.__init__)
def test_aws_sqs_queue_fetch_messages(mock_bongosec_integration, mock_sts_client, mock_get_url):
...
@patch('bongosec_integration.BongosecIntegration.get_sts_client')
@patch('bongosec_integration.BongosecIntegration.__init__', side_effect=bongosec_integration.BongosecIntegration.__init__)
def test_aws_sqs_queue_fetch_messages_handles_exception_when_getting_messages(mock_bongosec_integration, mock_sts_client):
...
@patch('bongosec_integration.BongosecIntegration.get_sts_client')
@patch('bongosec_integration.BongosecIntegration.__init__', side_effect=bongosec_integration.BongosecIntegration.__init__)
def test_aws_sqs_queue_get_messages(mock_bongosec_integration, mock_sts_client, mock_fetch):
...
@patch('bongosec_integration.BongosecIntegration.get_sts_client')
@patch('bongosec_integration.BongosecIntegration.__init__', side_effect=bongosec_integration.BongosecIntegration.__init__)
def test_aws_sqs_queue_sync_events(mock_bongosec_integration, mock_sts_client):

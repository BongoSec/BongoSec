...
class AWSService(bongosec_integration.BongosecAWSDatabase):
    """
    ...
    def __init__(self, reparse: bool, access_key: str, secret_key: str, profile: str, iam_role_arn: str,
        ...
        bongosec_integration.BongosecAWSDatabase.__init__(self, db_name=self.db_name, service_name=service_name,

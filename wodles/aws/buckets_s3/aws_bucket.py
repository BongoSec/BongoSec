...
RETRY_CONFIGURATION_URL = 'https://documentation.bongosec.github.io/current/amazon/services/prerequisites/' \
...
class AWSBucket(bongosec_integration.BongosecAWSDatabase):
    """
    ...
    def __init__(self, db_table_name, bucket, reparse, access_key, secret_key, profile, iam_role_arn,
        ...
        bongosec_integration.BongosecAWSDatabase.__init__(self,
        ...
        def exception_handler(error_txt, error_code):
            if self.skip_on_error:
                ...
                try:
                    ...
                    aws_tools.debug("++ Failed to send message to Bongosec", 1)
            else:

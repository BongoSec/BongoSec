filebeatout1=$(docker exec multi-node_bongosec.master_1 sh -c 'filebeat test output')
...
filebeatout2=$(docker exec multi-node_bongosec.worker_1 sh -c 'filebeat test output')

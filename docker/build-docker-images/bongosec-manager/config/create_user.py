...
try:
    ...
    logging.error("No module 'bongosec' found.")
    sys.exit(1)
...
if __name__ == "__main__":
    ...
    if username not in initial_users:
        ...
        # modify an existing user ("bongosec" or "bongosec-wui")
    ...
    for def_user in ['bongosec', 'bongosec-wui']:

...
#ifndef ARGV0
#define ARGV0 "bongosec-analysisd"
#endif
...
void w_inc_decoded_by_component_events(const char *component, const char *agent_id) {
    if (component != NULL) {
        if (!strcmp(component, "bongosec-agent")) {
            w_inc_agent_decoded_events(agent_id);
        } else if (!strcmp(component, "bongosec-agentlessd")) {
            w_inc_agentless_decoded_events(agent_id);
        } else if (!strcmp(component, "bongosec-monitord")) {
            w_inc_monitor_decoded_events(agent_id);
        } else if (!strcmp(component, "bongosec-remoted")) {
        ...
        } else if (!strcmp(component, "aws-s3") || !strcmp(component, "Bongosec-AWS")) {
        ...
        } else if (!strcmp(component, "docker-listener") || !strcmp(component, "Bongosec-Docker")) {
            w_inc_modules_docker_decoded_events(agent_id);
        } else if (!strcmp(component, "gcp-pubsub") || !strcmp(component, "gcp-bucket") || !strcmp(component, "Bongosec-GCloud")) {

...
/* Bongosec-logtest's fields names for the requests and responses */
...
/**
 * @brief Initialize Bongosec Logtest. Initialize the listener and create threads
...
/**
 * @brief Main function of Bongosec Logtest module
 *

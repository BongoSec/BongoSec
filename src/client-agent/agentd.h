...
/**
 * Function with all the necessary functionality to process the uninstallation validation of the Bongosec agent package.
...
static const char AG_IN_UNMERGE[] = "bongosec: Could not unmerge shared file.";

 ...
 *
 * Bongosec agents need to register to a manager before being able to start sending messages
 ...
 * For details on enrollment process @see https://documentation.bongosec.github.io/3.12/user-manual/registering/
 */

...
/// Enumeration of communication with Bongosec DB components.
typedef enum
{
...
/// Enumeration of communication with Bongosec DB status.
 ...
 *
 * @param[in] sock A Bongosec DB socket connection.

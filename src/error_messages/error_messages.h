...
#define HOME_ERROR    "(1108): Unable to find Bongosec install directory. Export it to BONGOSEC_HOME environment variable."
...
#define A_QUERY_ERROR           "(1286): Bongosec-db query error, check wdb logs."
#define INVALID_TYPE            "(1287): Incorrect/unknown type value %s."
#define WDBC_QUERY_EX_ERROR     "(1288): Bongosec-db query execution error."
...
#define AG_API_ERROR_CODE  "(4116): Unexpected status code in Bongosec agent package uninstallation request: %ld\n"
#define AG_REQUEST_FAIL    "(4117): Failed validation request to uninstall Bongosec agent package."
...
#define DB_COMPILED           "(5207): Bongosec not compiled with support for '%s'."
...
/* Bongosec Logtest error messsages */
...
#define LOGTEST_ERROR_INV_CONF                      "(7304): Invalid bongosec-logtest configuration"
...
#define BONGOSEC_HOMEDIR "Bongosec home directory: %s"
...
#define OS_NORMAL_BUFFER  "bongosec: Agent buffer: 'normal'."
#define OS_WARN_BUFFER  "bongosec: Agent buffer: '%d%%'."
#define OS_FULL_BUFFER  "bongosec: Agent buffer: 'full'."
#define OS_FLOOD_BUFFER "bongosec: Agent buffer: 'flooded'."

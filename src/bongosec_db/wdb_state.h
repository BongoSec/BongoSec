...
typedef struct _bongosecdb_breakdown_t {
    uint64_t remove_queries;
    struct timeval remove_time;
} bongosecdb_breakdown_t;
...
typedef struct _queries_breakdown_t {
    ...
    bongosecdb_breakdown_t bongosecdb_breakdown;
} queries_breakdown_t;
...
/**
 * @brief Increment total bongosecdb queries counter
 *
 */
void w_inc_bongosecdb();

/**
 * @brief Increment remove bongosecdb queries counter
 *
 */
void w_inc_bongosecdb_remove();

/**
 * @brief Increment remove bongosecdb time counter
 *
...
/**
 * @brief Create a JSON object with all the bongosec-db state information
 * @return JSON object
 */

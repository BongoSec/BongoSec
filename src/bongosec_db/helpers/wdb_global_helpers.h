/*
 * Bongosec DB helper module for agents database
 ...
 * @param[in] sock The Bongosec DB socket connection. If NULL, a new connection will be created and closed locally.
 ...
 * This method creates and sends a command to BongosecDB to receive the ID of every agent.
 ...
 * This method creates and sends a command to BongosecDB to set as disconnected all the

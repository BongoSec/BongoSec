...
TEST_F(PKGWrapperTest, pkgVersionXML)
{
    ...
    inputPath += getwd(NULL);
    inputPath += "/input_files";
    std::string package { "com.bongosec.pkg.bongosec-agent.plist" };

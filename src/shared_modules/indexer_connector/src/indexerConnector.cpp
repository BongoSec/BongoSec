...
constexpr auto USER_GROUP {"bongosec"};
                                                      ...
                                                      const SecureCommunication& secureCommunication) const
{
    ...
    constexpr auto ELEMENTS_PER_QUERY {10000}; // The max value for queries is 10000 in the bongosec-indexer.
    std::string scrollId;
                        ...
                        if (bulkSize / 2 < MINIMAL_ELEMENTS_PER_BULK)
                        {
                            ...
                            if (m_error413FirstTime == false)
                            {
                                ...
                                logError(IC_NAME,
                                         ...
                                         "the bongosec-indexer settings. Current data size: %llu.",
                                         data.size());
                            }

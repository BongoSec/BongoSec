...
public:
    ...
    {
        std::cout << "\nUsage: bongosec-keystore <option(s)>\n"
                  << "Options:\n"
                  ...
                  << "\nExample:"
                  << "\n\t./bongosec-keystore -f indexer -k username -v admin\n"
                  << "\n\t./bongosec-keystore -f indexer -k password -vp /path/to/file.txt\n"
                  << "\n\t./bongosec-keystore -f indexer -k password < /path/to/file.txt\n"
                  << "\n\techo 'pass' | ./bongosec-keystore -f indexer -k password\n"
                  << "\n\tcat /path/to/file.txt | ./bongosec-keystore -f indexer -k password\n"
                  << std::endl;
    }

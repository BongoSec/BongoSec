/**
 * Bongosec Inventory Harvester - SystemInventoryUpsertElement Unit tests
...
TEST_F(SystemInventoryUpsertElement, validAgentID_Packages)
{
    ...
    EXPECT_EQ(
        context->m_serializedElement,
        R"({"id":"001_packageItemId","operation":"INSERTED","data":{"package":{"architecture":"packageArchitecture","description":"packageDescription","installed":"packageInstallTime","name":"packageName","path":"packageLocation","size":0,"type":"packageFormat","version":"packageVersion","vendor":"packageVendor"},"agent":{"id":"001","name":"agentName","host":{"ip":"agentIp"},"version":"agentVersion"},"bongosec":{"schema":{"version":"1.0"}}}})");
}
...
TEST_F(SystemInventoryUpsertElement, validAgentID_Processes)
{
    ...
    EXPECT_EQ(
        context->m_serializedElement,
        R"({"id":"001_1234","operation":"INSERTED","data":{"process":{"args":["processName"],"args_count":1,"command_line":"processCmdline","name":"processName","pid":1234,"start":"processStartISO8601","parent":{"pid":1}},"agent":{"id":"001","name":"agentName","host":{"ip":"agentIp"},"version":"agentVersion"},"bongosec":{"schema":{"version":"1.0"}}}})");
}
...
TEST_F(SystemInventoryUpsertElement, validAgentID_Ports)
{
    ...
    EXPECT_EQ(
        context->m_serializedElement,
        R"({"id":"001_portItemId","operation":"INSERTED","data":{"agent":{"id":"001","name":"agentName","host":{"ip":"agentIp"},"version":"agentVersion"},"destination":{"ip":"portRemoteIp","port":1234},"file":{"inode":"1111"},"host":{"network":{"egress":{"queue":7000},"ingress":{"queue":11000}}},"interface":{"state":"portState"},"network":{"transport":"portProtocol"},"process":{"name":"portProcess","pid":4321},"source":{"ip":"portLocalIp","port":7777},"bongosec":{"schema":{"version":"1.0"}}}})");
}
...
TEST_F(SystemInventoryUpsertElement, validAgentID_Hotfixes)
{
    ...
    EXPECT_EQ(
        context->m_serializedElement,
        R"({"id":"001_KB12345","operation":"INSERTED","data":{"package":{"hotfix":{"name":"KB12345"}},"agent":{"id":"001","name":"agentName","host":{"ip":"agentIp"},"version":"agentVersion"},"bongosec":{"schema":{"version":"1.0"}}}})");
}
...
TEST_F(SystemInventoryUpsertElement, emptyBoardId_Hw)
{
    ...
    EXPECT_EQ(
        context->m_serializedElement,
        R"({"id":"001_unknown","operation":"INSERTED","data":{"host":{"cpu":{"cores":2,"name":"cpuName","speed":2497},"memory":{"free":0,"total":0,"used":0}},"agent":{"id":"001","name":"agentName","host":{"ip":"agentIp"},"version":"agentVersion"},"observer":{"serial_number":"unknown"},"bongosec":{"schema":{"version":"1.0"}}}})");
}
...
TEST_F(SystemInventoryUpsertElement, validAgentID_Hw)
{
    ...
    EXPECT_EQ(
        context->m_serializedElement,
        R"({"id":"001_boardInfo","operation":"INSERTED","data":{"host":{"cpu":{"cores":2,"name":"cpuName","speed":2497},"memory":{"free":0,"total":0,"used":0}},"agent":{"id":"001","name":"agentName","host":{"ip":"agentIp"},"version":"agentVersion"},"observer":{"serial_number":"boardInfo"},"bongosec":{"schema":{"version":"1.0"}}}})");
}
...
TEST_F(SystemInventoryUpsertElement, validAgentID_NetworkProtocol)
{
    ...
    EXPECT_EQ(
        context->m_serializedElement,
        R"({"id":"001_netProtoItemId","operation":"INSERTED","data":{"network":{"dhcp":true,"gateway":"netProtoGateway","metric":150,"type":"netProtoType"},"observer":{"ingress":{"interface":{"name":"netProtoIface"}}},"agent":{"id":"001","name":"agentName","host":{"ip":"agentIp"},"version":"agentVersion"},"bongosec":{"schema":{"version":"1.0"}}}})");
}
...
TEST_F(SystemInventoryUpsertElement, validAgentIDEmptyGateway_NetworkProtocol)
{
    ...
    EXPECT_EQ(
        context->m_serializedElement,
        R"({"id":"001_netProtoItemId","operation":"INSERTED","data":{"network":{"dhcp":true,"metric":150,"type":"netProtoType"},"observer":{"ingress":{"interface":{"name":"netProtoIface"}}},"agent":{"id":"001","name":"agentName","host":{"ip":"agentIp"},"version":"agentVersion"},"bongosec":{"schema":{"version":"1.0"}}}})");
}
...
TEST_F(SystemInventoryUpsertElement, validAgentID_NetIface)
{
    ...
    EXPECT_EQ(
        context->m_serializedElement,
        R"({"id":"001_netIfaceItemId","operation":"INSERTED","data":{"agent":{"id":"001","name":"agentName","host":{"ip":"agentIp"},"version":"agentVersion"},"host":{"mac":"netIfaceMac","network":{"ingress":{"bytes":1,"drops":2,"errors":3,"packets":4},"egress":{"bytes":5,"drops":6,"errors":7,"packets":8}}},"observer":{"ingress":{"interface":{"alias":"netIfaceAdapter","mtu":9,"name":"netIfaceName","state":"netIfaceState","type":"netIfaceType"}}},"bongosec":{"schema":{"version":"1.0"}}}})");
}
...
TEST_F(SystemInventoryUpsertElement, validAgentID_NetworkAddress)
{
    ...
    EXPECT_EQ(
        context->m_serializedElement,
        R"({"id":"001_netAddressItemId","operation":"INSERTED","data":{"network":{"broadcast":"192.168.0.255","ip":"192.168.0.1","name":"eth0","netmask":"255.255.255.0","protocol":"IPv4"},"agent":{"id":"001","name":"agentName","host":{"ip":"192.168.0.1"},"version":"agentVersion"},"bongosec":{"schema":{"version":"1.0"}}}})");
}
...
TEST_F(SystemInventoryUpsertElement, validAgentIDEmptyBroadcast_NetworkAddress)
{
    ...
    EXPECT_EQ(
        context->m_serializedElement,
        R"({"id":"001_netAddressItemId","operation":"INSERTED","data":{"network":{"ip":"192.168.0.1","name":"eth0","netmask":"255.255.255.0","protocol":"IPv4"},"agent":{"id":"001","name":"agentName","host":{"ip":"192.168.0.1"},"version":"agentVersion"},"bongosec":{"schema":{"version":"1.0"}}}})");
}
...
TEST_F(SystemInventoryUpsertElement, validAgentIDEmptyNetmask_NetworkAddress)
{
    ...
    EXPECT_EQ(
        context->m_serializedElement,
        R"({"id":"001_netAddressItemId","operation":"INSERTED","data":{"network":{"broadcast":"192.168.0.255","ip":"192.168.0.1","name":"eth0","protocol":"IPv4"},"agent":{"id":"001","name":"agentName","host":{"ip":"192.168.0.1"},"version":"agentVersion"},"bongosec":{"schema":{"version":"1.0"}}}})");
}
...
TEST_F(SystemInventoryUpsertElement, validAgentIDEmptyAddress_NetworkAddress)
{
    ...
    EXPECT_EQ(
        context->m_serializedElement,
        R"({"id":"001_netAddressItemId","operation":"INSERTED","data":{"network":{"broadcast":"192.168.0.255","name":"eth0","netmask":"255.255.255.0","protocol":"IPv4"},"agent":{"id":"001","name":"agentName","host":{"ip":"192.168.0.1"},"version":"agentVersion"},"bongosec":{"schema":{"version":"1.0"}}}})");
}

...
void InventoryHarvesterFacade::initBongosecDBAgentEventSubscription()
{
...
void InventoryHarvesterFacade::initBongosecDBFimEventSubscription()
{
...
void InventoryHarvesterFacade::initBongosecDBInventoryEventSubscription()
{
    ...
    const nlohmann::json& configuration)
{
    try
    {
        ...
        initBongosecDBAgentEventSubscription();
        initBongosecDBInventoryEventSubscription();
        initBongosecDBFimEventSubscription();

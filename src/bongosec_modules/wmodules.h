...
extern int wm_max_eps;          // Maximum events per second sent by OpenScap Bongosec Module
...
/*
 * @brief Get ID group of Bongosec user.
 *
 * @return ID group.
 */
...
/*
 * @brief Set ID group of bongosec modules
 *

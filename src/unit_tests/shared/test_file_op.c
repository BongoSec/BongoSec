...
{
    char *argv0 = "/usr/share/bongosec/bin/test";
    ...
    expect_string(__wrap_stat, __file, "/usr/share/bongosec");
    will_return(__wrap_stat, &stat_buf);
    will_return(__wrap_stat, 0);

    val = w_homedir(argv0);
    assert_string_equal(val, "/usr/share/bongosec");
    free(val);
}
...
void test_w_homedir_env_var(void **state)
{
    ...
    expect_string(__wrap_getenv, name, BONGOSEC_HOME_ENV);
    will_return(__wrap_getenv, "/home/bongosec");

    expect_string(__wrap_stat, __file, "/home/bongosec");
    will_return(__wrap_stat, &stat_buf);
    will_return(__wrap_stat, 0);

    val = w_homedir(argv0);
    assert_string_equal(val, "/home/bongosec");
    free(val);
}
...
void test_w_homedir_stat_fail(void **state)
{
    ...
    expect_string(__wrap__merror_exit, formatted_msg, "(1108): Unable to find Bongosec install directory. Export it to BONGOSEC_HOME environment variable.");

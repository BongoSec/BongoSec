...
#include "../../wrappers/bongosec/shared/cluster_op_wrappers.h"
#include "../../wrappers/bongosec/shared/debug_op_wrappers.h"
#include "../../wrappers/bongosec/shared/pthreads_op_wrappers.h"
#include "../../wrappers/bongosec/os_net/os_net_wrappers.h"
#include "../../wrappers/bongosec/bongosec_modules/wm_task_manager_wrappers.h"

#include "../../bongosec_modules/wmodules.h"
#include "../../bongosec_modules/task_manager/wm_task_manager.h"
#include "../../bongosec_modules/task_manager/wm_task_manager_tasks.h"
...
void test_wm_task_manager_destroy(void **state)
{
    ...
    expect_string(__wrap__mtinfo, tag, "bongosec-modulesd:task-manager");
...
void test_wm_task_manager_init_bind_err(void **state)
{
    ...
    expect_string(__wrap__mterror, tag, "bongosec-modulesd:task-manager");
...
void test_wm_task_manager_dispatch_ok(void **state)
{
    ...
    expect_string(__wrap__mtdebug1, tag, "bongosec-modulesd:task-manager");

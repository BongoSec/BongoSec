...
#include <cmocka.h>
#include <stdio.h>
#include "../../wrappers/bongosec/data_provider/sysInfo_wrappers.h"
#include "../../../data_provider/include/sysInfo.h"
#include "../../../bongosec_modules/wm_control.h"
...
static void test_wm_control_getPrimaryIP_sysinfo_network_return_error(void ** state) {
    ...
    expect_string(__wrap__mterror, tag, "bongosec-modulesd:control");

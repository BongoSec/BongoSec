...
#include "../../wrappers/bongosec/shared/url_wrappers.h"
#include "../../wrappers/bongosec/os_crypto/sha1_op_wrappers.h"
#include "../../wrappers/bongosec/bongosec_db/wdb_wrappers.h"
#include "../../wrappers/bongosec/bongosec_modules/wm_agent_upgrade_wrappers.h"

#include "../../bongosec_modules/wmodules.h"
#include "../../bongosec_modules/agent_upgrade/manager/wm_agent_upgrade_validate.h"
#include "../../bongosec_modules/agent_upgrade/manager/wm_agent_upgrade_tasks.h"
...
void test_wm_agent_upgrade_validate_wpk_version_windows_http_ok(void **state)
{
    ...
    expect_string(__wrap_wurl_http_get, url, "http://packages.bongosec.github.io/wpk/windows/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
    ...
    assert_int_equal(ret, WM_UPGRADE_SUCCESS);
    assert_string_equal(task->wpk_repository, "http://packages.bongosec.github.io/wpk/windows/");
    assert_string_equal(task->wpk_file, "bongosec_agent_v3.13.1_windows.wpk");
...
void test_wm_agent_upgrade_validate_wpk_version_windows_invalid_version(void **state)
{
    wm_agent_info *agent = state[0];
    wm_upgrade_task *task = state[1];
    char *repo = "packages.bongosec.github.io/4.x/wpk";
    char *versions = NULL;
    ...
    expect_string(__wrap_wurl_http_get, url, "http://packages.bongosec.github.io/4.x/wpk/windows/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
...
void test_wm_agent_upgrade_validate_wpk_version_windows_invalid_repo(void **state)
{
    wm_agent_info *agent = state[0];
    wm_upgrade_task *task = state[1];
    char *repo = "error.bongosec.github.io/wpk/";
    char *versions = NULL;
    ...
    expect_string(__wrap_wurl_http_get, url, "http://error.bongosec.github.io/wpk/windows/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
...
void test_wm_agent_upgrade_validate_wpk_version_linux_http_ok(void **state)
{
    ...
    expect_string(__wrap_wurl_http_get, url, "http://packages.bongosec.github.io/wpk/linux/x64/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
    ...
    assert_int_equal(ret, WM_UPGRADE_SUCCESS);
    assert_string_equal(task->wpk_repository, "http://packages.bongosec.github.io/wpk/linux/x64/");
    assert_string_equal(task->wpk_file, "bongosec_agent_v3.13.1_linux_x64.wpk");
    assert_string_equal(task->wpk_sha1, "4a313b1312c23a213f2e3209fe0909dd");
}
...
void test_wm_agent_upgrade_validate_wpk_version_linux_invalid_version(void **state)
{
    ...
    expect_string(__wrap_wurl_http_get, url, "http://packages.bongosec.github.io/4.x/wpk/linux/x64/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
...
void test_wm_agent_upgrade_validate_wpk_version_linux_invalid_repo(void **state)
{
    ...
    expect_string(__wrap_wurl_http_get, url, "http://error.bongosec.github.io/wpk/linux/x64/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
...
void test_wm_agent_upgrade_validate_wpk_version_macos_http_ok(void **state)
{
    ...
    expect_string(__wrap_wurl_http_get, url, "http://packages.bongosec.github.io/wpk/macos/x64/pkg/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
    ...
    assert_int_equal(ret, WM_UPGRADE_SUCCESS);
    assert_string_equal(task->wpk_repository, "http://packages.bongosec.github.io/wpk/macos/x64/pkg/");
    assert_string_equal(task->wpk_file, "bongosec_agent_v3.13.1_macos_x64.wpk");
    assert_string_equal(task->wpk_sha1, "4a313b1312c23a213f2e3209fe0909dd");
}
...
void test_wm_agent_upgrade_validate_wpk_version_linux_package_unsupported_x86_64(void **state)
{
    ...
    assert_int_equal(ret, WM_UPGRADE_SYSTEM_NOT_SUPPORTED);
    assert_string_equal(task->wpk_repository, "packages.bongosec.github.io/4.x/wpk/");
    assert_null(task->wpk_file);
    assert_null(task->wpk_sha1);
}
...
{
    wm_upgrade_task *task = state[1];
    char *bongosec_version = "v3.9.1";
    char *platform = "ubuntu";

    task->force_upgrade = false;

    int ret = wm_agent_upgrade_validate_version(bongosec_version, platform, WM_UPGRADE_UPGRADE, task);
...
void test_wm_agent_upgrade_validate_version_upgrade_custom_ok(void **state)
{
    ...
    int ret = wm_agent_upgrade_validate_version(bongosec_version, platform, WM_UPGRADE_UPGRADE_CUSTOM, task);
...
void test_wm_agent_upgrade_validate_wpk_exist(void **state)
{
    ...
    expect_string(__wrap_wfopen, path, "var/upgrade/bongosec_agent_v4.0.0_windows.wpk");
    expect_string(__wrap_wfopen, mode, "rb");
    will_return(__wrap_wfopen, 1);

    expect_string(__wrap_OS_SHA1_File, fname, "var/upgrade/bongosec_agent_v4.0.0_windows.wpk");
...
void test_wm_agent_upgrade_validate_task_status_message_error_code(void **state)
{
    ...
    expect_string(__wrap__mterror, tag, "bongosec-modulesd:agent-upgrade");

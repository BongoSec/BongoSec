...
#include "../../wrappers/bongosec/shared/queue_linked_op_wrappers.h"
#include "../../wrappers/bongosec/shared/version_op_wrappers.h"
...
#include "../../bongosec_modules/agent_upgrade/manager/wm_agent_upgrade_upgrades.h"
...
void test_wm_agent_upgrade_send_command_to_agent_ok(void **state)
{
    ...
    expect_string(__wrap__mtdebug2, tag, "bongosec-modulesd:agent-upgrade");
...
void test_wm_agent_upgrade_send_open_retry_err(void **state)
{
    ...
    expect_string_count(__wrap__mtdebug2, tag, "bongosec-modulesd:agent-upgrade", 20);
    expect_string(__wrap__mtdebug2, formatted_msg, "(8165): Sending message to agent: '039 com open wb test.wpk'");
    expect_string(__wrap__mtdebug2, formatted_msg, "(8166): Receiving message from agent: 'err Could not open file in agent'");
    expect_string(__wrap__mtdebug2, formatted_msg, "(8165): Sending message to agent: '039 com open wb test.wpk'");
    expect_string(__wrap__mtdebug2, formatted_msg, "(8166): Receiving message from agent: 'err Could not open file in agent'");
...
void test_wm_agent_upgrade_send_write_ok(void **state)
{
    ...
    int agent = 39;
    char *wpk_file = "test.wpk";
    char *file_path = "/var/upgrade/bongosec_agent.wpk";
    int chunk_size = 5;
    char *chunk = "test\n";
...
void test_wm_agent_upgrade_send_wpk_to_agent_upgrade_linux_ok(void **state)
{
    ...
    os_strdup("v3.13.0", agent_task->agent_info->bongosec_version);
    ...
    expect_string(__wrap_compare_bongosec_versions, version1, agent_task->agent_info->bongosec_version);
    expect_string(__wrap_compare_bongosec_versions, version2, WM_UPGRADE_NEW_UPGRADE_MECHANISM);
    expect_value(__wrap_compare_bongosec_versions, compare_patch, 1);
    will_return(__wrap_compare_bongosec_versions, -1);
    ...
    expect_string_count(__wrap__mtdebug2, tag, "bongosec-modulesd:agent-upgrade", 12);
...
void test_wm_agent_upgrade_send_wpk_to_agent_upgrade_send_sha1_err(void **state)
{
    ...
    expect_string_count(__wrap__mtdebug2, tag, "bongosec-modulesd:agent-upgrade", 10);
    expect_string(__wrap__mtdebug2, formatted_msg, "(8165): Sending message to agent: '111 com lock_restart -1'");
    expect_string(__wrap__mtdebug2, formatted_msg, "(8166): Receiving message from agent: 'ok '");
    expect_string(__wrap__mtdebug2, formatted_msg, "(8165): Sending message to agent: '111 com open wb test.wpk'");
    expect_string(__wrap__mtdebug2, formatted_msg, "(8166): Receiving message from agent: 'ok '");
...
void test_wm_agent_upgrade_send_wpk_to_agent_upgrade_close_file_err(void **state)
{
    ...
    expect_string_count(__wrap__mtdebug2, tag, "bongosec-modulesd:agent-upgrade", 8);
    expect_string(__wrap__mtdebug2, formatted_msg, "(8165): Sending message to agent: '111 com lock_restart -1'");
    expect_string(__wrap__mtdebug2, formatted_msg, "(8166): Receiving message from agent: 'ok '");
    expect_string(__wrap__mtdebug2, formatted_msg, "(8165): Sending message to agent: '111 com open wb test.wpk'");
    expect_string(__wrap__mtdebug2, formatted_msg, "(8166): Receiving message from agent: 'ok '");
...
void test_wm_agent_upgrade_send_wpk_to_agent_upgrade_write_file_err(void **state)
{
    ...
    expect_string_count(__wrap__mtdebug2, tag, "bongosec-modulesd:agent-upgrade", 6);
    expect_string(__wrap__mtdebug2, formatted_msg, "(8165): Sending message to agent: '111 com lock_restart -1'");
    expect_string(__wrap__mtdebug2, formatted_msg, "(8166): Receiving message from agent: 'ok '");
    expect_string(__wrap__mtdebug2, formatted_msg, "(8165): Sending message to agent: '111 com open wb test.wpk'");
    expect_string(__wrap__mtdebug2, formatted_msg, "(8166): Receiving message from agent: 'ok '");
...
void test_wm_agent_upgrade_send_wpk_to_agent_upgrade_open_file_err(void **state)
{
    ...
    expect_string_count(__wrap__mtdebug2, tag, "bongosec-modulesd:agent-upgrade", 22);
    expect_string(__wrap__mtdebug2, formatted_msg, "(8165): Sending message to agent: '111 com lock_restart -1'");
    expect_string(__wrap__mtdebug2, formatted_msg, "(8166): Receiving message from agent: 'ok '");
    expect_string(__wrap__mtdebug2, formatted_msg, "(8165): Sending message to agent: '111 com open wb test.wpk'");
    expect_string(__wrap__mtdebug2, formatted_msg, "(8166): Receiving message from agent: 'err '");
...
void test_wm_agent_upgrade_send_wpk_to_agent_upgrade_lock_restart_err(void **state)
{
    ...
    expect_string_count(__wrap__mtdebug2, tag, "bongosec-modulesd:agent-upgrade", 2);
    expect_string(__wrap__mtdebug2, formatted_msg, "(8165): Sending message to agent: '111 com lock_restart -1'");
    expect_string(__wrap__mtdebug2, formatted_msg, "(8166): Receiving message from agent: 'err '");
...
void test_wm_agent_upgrade_start_upgrade_upgrade_legacy_ok(void **state)
{
    ...
    // compare_bongosec_versions

    expect_string(__wrap_compare_bongosec_versions, version1, "v3.13.1");
    expect_string(__wrap_compare_bongosec_versions, version2, WM_UPGRADE_NEW_UPGRADE_MECHANISM);
    expect_value(__wrap_compare_bongosec_versions, compare_patch, 1);
    will_return(__wrap_compare_bongosec_versions, -1);

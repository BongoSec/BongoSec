...
#include <shared.h>
#include "../../../bongosec_modules/wmodules_def.h"
#include "../../../bongosec_modules/wm_database.h"

#include "../../wrappers/common.h"
#include "../../wrappers/bongosec/os_crypto/keys_wrappers.h"
...
void test_wm_sync_group_file_error_agent_id(void **state) {
    ...
    expect_string(__wrap__mtdebug1, tag, "bongosec-modulesd:database");
...
void test_sync_keys_with_wdb_insert(void **state) {
    ...
    expect_string(__wrap__mtdebug2, tag, "bongosec-modulesd:database");
...
void test_sync_keys_with_wdb_insert_delete(void **state) {
    ...
    expect_string(__wrap_wdbc_query_ex, query, "bongosecdb remove 1");
    expect_value(__wrap_wdbc_query_ex, len, OS_SIZE_1024);
    will_return(__wrap_wdbc_query_ex, "ok");
    will_return(__wrap_wdbc_query_ex, -1);

    expect_string(__wrap__mtdebug1, tag, "bongosec-modulesd:database");
    expect_string(__wrap__mtdebug1, formatted_msg, "Could not remove the bongosec-db DB of the agent 1.");
...
void test_sync_keys_with_wdb_null(void **state) {
    ...
    expect_string(__wrap__mterror, tag, "bongosec-modulesd:database");

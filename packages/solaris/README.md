...
In this repository, you can find the necessary tools to build a Bongosec package for solaris 10 and 11, using scripts or automated using vagrant, and the tools to build a solaris 10 and 11 vagrant box:
...
Please, visit the following link for the full Solaris packages building documentation: [Generate Bongosec Solaris packages.](https://documentation.bongosec.github.io/current/development/packaging/generate-sol-package.html)

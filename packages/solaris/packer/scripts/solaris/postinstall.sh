...
# install bongosec dependencies & some important packages
...
curl -L http://packages.bongosec.github.io/utils/gcc/gcc-5.5.0.tar.gz | gtar xz
cd gcc-5.5.0
curl -L http://packages.bongosec.github.io/utils/gcc/mpfr-2.4.2.tar.bz2 | gtar xj
mv mpfr-2.4.2 mpfr
curl -L http://packages.bongosec.github.io/utils/gcc/gmp-4.3.2.tar.bz2 | gtar xj
mv gmp-4.3.2 gmp
curl -L http://packages.bongosec.github.io/utils/gcc/mpc-0.8.1.tar.gz | gtar xz
mv mpc-0.8.1 mpc
curl -L http://packages.bongosec.github.io/utils/gcc/isl-0.14.tar.bz2 | gtar xj
mv isl-0.14 isl
...
curl -sL http://packages.bongosec.github.io/utils/cmake/cmake-3.18.3.tar.gz | gtar xz
cd cmake-3.18.3

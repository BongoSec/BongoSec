...
help() {
    ...
    echo
    echo "    -b, --branch <branch>     [Optional] Select Git branch to compile Bongosec code."
    echo "    --sources <path>          [Optional] Absolute path containing bongosec source code. This option will use local source code instead of downloading it from GitHub. By default: '../../src'."

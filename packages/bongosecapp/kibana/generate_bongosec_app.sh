...
# Program to build the Bongosec App for Kibana
...
BRANCH_TAG=""
CHECKSUMDIR=""
CONTAINER_NAME="bongosec-kibana-app-builder"
...
help() {
    ...
    echo "    -s, --store <path>        [Optional] Set the destination path of package, by default /tmp/bongosec-app."
...
build_package(){
    ...
    # Build the Bongosec Kibana app package using the build docker image

...
references:
    ...
    - https://documentation.bongosec.github.io/current/user-manual/reference/ossec-conf/localfile.html#reconnect-time
...
config_path = Path(CONFIGURATIONS_PATH, 'bongosec_basic_configuration_reconnect_time.yaml')
...
def test_configuration_reconnect_time(test_configuration, test_metadata, truncate_monitored_files,
    ...
    '''
    description: Check if the 'bongosec-logcollector' daemon detects invalid settings for the 'reconnect_time' tag.
    ...
    if test_metadata['valid_value']:
        ...
        if test_metadata['reconnect_time'] in problematic_values:
            pytest.xfail("Logcolector accepts invalid values. Issue: https://github.com/bongosec/bongosec/issues/8158")
        else:
            control_service('start', daemon=LOGCOLLECTOR_DAEMON)
            ...
            assert (bongosec_log_monitor.callback_result != None), patterns.ERROR_INVALID_RECONNECTION_TIME

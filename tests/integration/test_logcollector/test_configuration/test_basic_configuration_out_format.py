...
brief: The 'bongosec-logcollector' daemon monitors configured files and commands for new log messages.
       ...
       the 'out_format' tag and the Bongosec API returns the same values for the configured
...
config_path = Path(CONFIGURATIONS_PATH, 'bongosec_basic_configuration_out_format.yaml')
...
def test_configuration_out_format(test_configuration, test_metadata, set_bongosec_configuration, configure_local_internal_options, daemons_handler_module, stop_logcollector):
    '''
    description: Check if the 'bongosec-logcollector' daemon detects invalid settings for the 'out_format' tag.
    ...
    input_description: A configuration template (test_basic_configuration_out_format) is contained in an
                       external YAML file (bongosec_basic_configuration.yaml). That template is combined with

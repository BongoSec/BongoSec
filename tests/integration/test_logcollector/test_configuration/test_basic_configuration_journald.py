...
brief: The 'bongosec-logcollector' daemon monitors configured files and commands for new log messages.
       ...
       the 'localfile' with 'journal' as 'log_format' is set in the configuration, and the Bongosec API returns the 
...
def test_configuration_location(test_configuration, test_metadata, truncate_monitored_files, configure_local_internal_options,
    ...
    '''
    description: Check if the 'bongosec-logcollector' daemon starts properly when the 'journald' tag is used as log_format.
                 For this purpose, the test will configure the logcollector to monitor a 'journald'.
                 Finally, the test will verify that the Bongosec component is started by checking its process, and the Bongosec API returns the correct values
    ...
    assertions:
        - Verify that the Bongosec component (agent or manager) can start when the 'jouranld' tag is used as log_format.
        - Verify that the Bongosec API returns the correct values for the 'localfile' section.

...
def test_configuration_location(test_configuration, test_metadata, truncate_monitored_files, configure_local_internal_options,
                                remove_all_localfiles_bongosec_config, set_bongosec_configuration, daemons_handler, wait_for_logcollector_start):
    '''
    description: Check if the 'bongosec-logcollector' daemon starts properly when the 'journald' tag is used and read the logs from the 'systemd/journald' component.
    ...
    assertions:
        ...
        - Verify that the Bongosec component (agent or manager) can read the logs from the 'systemd-journald'.

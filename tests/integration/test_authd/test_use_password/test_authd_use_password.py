...
def read_random_pass():
    """
    Search for the random password creation in Bongosec logs
    """
    passw = None
    try:
        with open(BONGOSEC_LOG_PATH, 'r') as log_file:
...
def test_authd_use_password(test_configuration, test_metadata, set_bongosec_configuration,

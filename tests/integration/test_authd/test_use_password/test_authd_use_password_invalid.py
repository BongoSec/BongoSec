...
def test_authd_use_password_invalid(test_configuration, test_metadata, set_bongosec_configuration, truncate_monitored_files_module,
    ...
    assertions:
        ...
        - bongosec-manager.service must not be able to restart.

    input_description:
        ./data/configuration_template/config_authd_use_password_invalid.yaml: Bongosec config needed for the tests.
    ...
    if log == 'Invalid password provided.':
        pytest.xfail(reason="No password validation in authd.pass - Issue bongosec/bongosec#16282.")

    # Verify bongosec-manager fails at restart.

...
brief: These tests will check if the 'bongosec-authd' daemon correctly handles the enrollment requests,
       ...
       The 'bongosec-authd' daemon can automatically add a Bongosec agent to a Bongosec manager and provide
...
def test_ossec_auth_messages(test_configuration, test_metadata, set_bongosec_configuration,
    ...
    '''
    description:
        Checks if when the `bongosec-authd` daemon receives different types of enrollment requests,

...
references:
    - https://documentation.bongosec.github.io/current/user-manual/registering/restful-api-registration.html
...
def test_agentd_server_configuration(test_metadata, truncate_monitored_files_module,
    ...
    '''
    description:
        Checks `bongosec-api` responds correctly to agent registration requests. Also, ensure client.keys is update

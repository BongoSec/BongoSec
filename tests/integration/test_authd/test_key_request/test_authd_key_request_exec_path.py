...
from bongosec_testing.constants.daemons import AUTHD_DAEMON
...
monitored_sockets_params = [('bongosec-authd', None, True)]
...
def test_key_request_exec_path(test_configuration, test_metadata, set_bongosec_configuration,
    ...
    for log in expected_logs:
        log = re.escape(log)
        bongosec_log_monitor.start(callback=callbacks.generate_callback(fr'{PREFIX}{log}'), timeout=10)

...
import pytest
from bongosec_testing.constants.paths.sockets import MODULESD_C_INTERNAL_SOCKET_PATH, MODULESD_KREQUEST_SOCKET_PATH
...
monitored_sockets_params = [('bongosec-clusterd', mitm_master, True), ('bongosec-authd', None, True)]
receiver_sockets, monitored_sockets = None, None


# Tests
@pytest.mark.parametrize('test_configuration,test_metadata', zip(test_configuration, test_metadata), ids=test_cases_ids)
def test_authd_key_request_worker(test_configuration, test_metadata, set_bongosec_configuration,

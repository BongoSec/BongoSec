...
from bongosec_testing.modules.fim.patterns import FILE_LIMIT_DISABLED
...
def test_limit_disabled(test_configuration, test_metadata, set_bongosec_configuration, truncate_monitored_files,
                        configure_local_internal_options, folder_to_monitor, daemons_handler, start_monitoring):
    '''
    description: Check if the 'bongosec-syscheckd' daemon detects that the 'file_limit' feature of FIM is disabled.
    ...
    bongosec_log_monitor.start(generate_callback(FILE_LIMIT_DISABLED))

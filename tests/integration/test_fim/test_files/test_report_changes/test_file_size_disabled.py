...
def test_file_size_disabled(test_configuration, test_metadata, configure_local_internal_options, truncate_monitored_files,
    ...
    bongosec_log_monitor.start(generate_callback(FILE_SIZE_LIMIT_REACHED), timeout=30)
    assert (bongosec_log_monitor.callback_result == None), f'Error, unexpected file_size limit event.'

...
from bongosec_testing.constants.platforms import WINDOWS, MACOS
...
from bongosec_testing.modules.fim.utils import get_fim_event_data
from bongosec_testing.tools.monitors.file_monitor import FileMonitor
from bongosec_testing.utils.file import truncate_file, write_file_write
...
def test_large_changes(test_configuration, test_metadata, configure_local_internal_options,
                        truncate_monitored_files, set_bongosec_configuration, folder_to_monitor, daemons_handler, detect_end_scan):
    '''
    description: Check if the 'bongosec-syscheckd' daemon detects the character limit in the file changes is reached

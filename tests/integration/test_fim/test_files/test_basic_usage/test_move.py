...
def test_move(test_configuration, test_metadata, set_bongosec_configuration, configure_local_internal_options,
              truncate_monitored_files, folder_to_monitor, daemons_handler, start_monitoring, path_to_edit, detect_end_scan):
    '''
    description: Check if the 'bongosec-syscheckd' daemon detects 'added' and 'deleted' events when moving a

...
from bongosec_testing.modules.fim.patterns import EVENT_TYPE_ADDED, EVENT_TYPE_DELETED
...
def test_rename(test_configuration, test_metadata, set_bongosec_configuration, configure_local_internal_options,
                truncate_monitored_files, folder_to_monitor, daemons_handler, start_monitoring, path_to_edit):
    '''
    description: Check if the 'bongosec-syscheckd' daemon detects 'added' and 'deleted' events when renaming a
    ...
    input_description: The test cases are contained in external YAML file (cases_rename.yaml) which includes
                       configuration parameters for the 'bongosec-syscheckd' daemon and testing directories

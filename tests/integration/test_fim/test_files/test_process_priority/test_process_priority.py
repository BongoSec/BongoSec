...
brief: File Integrity Monitoring (FIM) system watches selected files and triggering alerts when
       ...
       the 'bongosec-syscheckd' daemon set in the 'process_priority' tag is applied successfully.
...
references:
    ...
    - https://documentation.bongosec.github.io/current/user-manual/reference/ossec-conf/syscheck.html#process-priority
...
from bongosec_testing.modules.agentd.configuration import AGENTD_DEBUG
...
from bongosec_testing.constants.daemons import SYSCHECK_DAEMON
...
def test_process_priority(test_configuration, test_metadata, configure_local_internal_options,
    ...
    '''
    description: Check if the process priority of the 'bongosec-syscheckd' daemon set in the 'process_priority' tag
                 ...
                 the 'bongosec-syscheckd' process. Finally, the test will compare the current process priority
    ...
    assertions:
        - Verify that the 'bongosec-syscheckd' daemon is running.
        - Verify that the process priority of the 'bongosec-syscheckd' daemon matches the 'process_priority' tag.

    input_description: A test case (ossec_conf) is contained in external YAML file (cases_process_priority.yaml)
                       which includes configuration settings for the 'bongosec-syscheckd' daemon and,

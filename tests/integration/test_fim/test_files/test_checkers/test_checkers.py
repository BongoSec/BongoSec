...
from bongosec_testing.modules.fim.patterns import EVENT_TYPE_ADDED, EVENT_TYPE_DELETED, EVENT_TYPE_MODIFIED
...
def test_checkers(test_configuration, test_metadata, set_bongosec_configuration, configure_local_internal_options,
                  truncate_monitored_files, folder_to_monitor, file_to_monitor, daemons_handler, start_monitoring):
    '''
    description: Check if the 'bongosec-syscheckd' daemon adds in the generated events the 'check_' specified in
    ...
    input_description: The test cases are contained in external YAML file (cases_checkers.yaml) which includes
                       configuration parameters for the 'bongosec-syscheckd' daemon and testing directories to monitor.

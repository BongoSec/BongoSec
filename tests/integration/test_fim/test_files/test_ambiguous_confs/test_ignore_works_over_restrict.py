...
def test_ignore_works_over_restrict(test_configuration, test_metadata, set_bongosec_configuration, configure_local_internal_options,
    ...
    bongosec_log_monitor.start(callback=generate_callback(test_metadata['regex']))

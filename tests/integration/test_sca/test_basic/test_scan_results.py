...
references:
    - https://documentation.bongosec.github.io/current/user-manual/capabilities/sec-config-assessment/index.html
...
def test_sca_scan_results(test_configuration, test_metadata, prepare_cis_policies_file, truncate_monitored_files,
                          set_bongosec_configuration, configure_local_internal_options, daemons_handler,
    ...
    parameters:
        - configuration:
            type: dict
            brief: Bongosec configuration data. Needed for set_bongosec_configuration fixture.
        - metadata:
            type: dict
            brief: Bongosec configuration metadata.
        - prepare_cis_policies_file:
            type: fixture
            brief: copy test sca policy file. Delete it after test.
        - set_bongosec_configuration:
            type: fixture
            brief: Set the bongosec configuration according to the configuration data.
        ...
        - restart_modulesd_function:
            type: fixture
            brief: Restart the bongosec-modulesd daemon.
        - wait_for_sca_enabled:
            type: fixture

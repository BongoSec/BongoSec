...
from bongosec_testing.utils.db_queries.aws_db import get_multiple_s3_db_row, get_service_db_row, get_s3_db_row
from bongosec_testing.modules.aws.utils import (call_aws_module, upload_log_events, create_log_stream, path_exist,
                                             get_last_file_key, analyze_command_output,
                                             generate_file, upload_bucket_file)
from bongosec_testing.modules.aws.patterns import (NO_LOG_PROCESSED, NO_BUCKET_LOG_PROCESSED, MARKER, NO_NEW_EVENTS,
                                                EVENT_SENT)
...
def test_bucket_without_only_logs_after(
        ...
        load_bongosec_basic_configuration, set_bongosec_configuration, clean_s3_cloudtrail_db,
        configure_local_internal_options_function, truncate_monitored_files, restart_bongosec_function,
        file_monitoring
):
    """
    ...
    parameters:
        ...
        - restart_bongosec_daemon_function:
            type: fixture
...
def test_service_without_only_logs_after(
        ...
        load_bongosec_basic_configuration, set_bongosec_configuration, clean_aws_services_db,
        configure_local_internal_options_function, truncate_monitored_files, restart_bongosec_function, file_monitoring
):
    """
...
def test_bucket_multiple_calls(
        ...
        load_bongosec_basic_configuration, restart_bongosec_function
):
    """
...
def test_inspector_multiple_calls(
    metadata, clean_aws_services_db, load_bongosec_basic_configuration, restart_bongosec_function
):
    """
    description: Call the AWS module multiple times with different only_logs_after values.
    test_phases:
...
def test_cloudwatch_multiple_calls(
        ...
        logs_clients, load_bongosec_basic_configuration, restart_bongosec_function
):
    """
    description: Call the AWS module multiple times with different only_logs_after values.
    test_phases:

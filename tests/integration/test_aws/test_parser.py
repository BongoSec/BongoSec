...
def test_bucket_and_service_missing(
        test_configuration, metadata, load_bongosec_basic_configuration, set_bongosec_configuration,
        configure_local_internal_options_function, truncate_monitored_files, restart_bongosec_function_without_exception,
        file_monitoring
):
    """
    ...
    parameters:
        ...
        - restart_bongosec_function_without_exception:
            type: fixture
            brief: Restart the bongosec service catching the exception.
        - file_monitoring:
            type: fixture

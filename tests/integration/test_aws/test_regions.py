...
from bongosec_testing.utils.db_queries.aws_db import (get_multiple_service_db_row, table_exists_or_has_values,
...
def test_regions(
        test_configuration, metadata, load_bongosec_basic_configuration,  create_test_bucket, manage_bucket_files,
        set_bongosec_configuration, clean_s3_cloudtrail_db, configure_local_internal_options_function,
        truncate_monitored_files, restart_bongosec_function, file_monitoring
):
    """
...
def test_cloudwatch_regions(
        test_configuration, metadata, load_bongosec_basic_configuration, create_test_log_group, create_test_log_stream,
        manage_log_group_events, set_bongosec_configuration, clean_aws_services_db,
...
def test_inspector_regions(
        test_configuration, metadata, load_bongosec_basic_configuration,
        set_bongosec_configuration, clean_aws_services_db, configure_local_internal_options_function,
        truncate_monitored_files, restart_bongosec_function, file_monitoring
):
    """
    description: Only the logs for the specified region are processed.

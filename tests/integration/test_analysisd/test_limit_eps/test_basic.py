...
def test_enabled(test_configuration, test_metadata, load_bongosec_basic_configuration, set_bongosec_configuration,
...
def test_disabled(test_configuration, test_metadata, load_bongosec_basic_configuration, set_bongosec_configuration,
                 truncate_monitored_files, daemons_handler):
    """
    ...
    """
    # Start monitor
    monitor_disabled = file_monitor.FileMonitor(BONGOSEC_LOG_PATH)

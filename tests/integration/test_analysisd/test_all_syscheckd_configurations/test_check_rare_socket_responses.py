...
monitored_sockets_params = [(BONGOSEC_DB_DAEMON, mitm_wdb, True), (ANALYSISD_DAEMON, None, None)]
...
def test_validate_rare_socket_responses(
    ...
    '''
    description: Validate each response from the 'bongosec-analysisd' daemon socket
                 to the 'bongosec-db' daemon socket using rare 'syscheck' events

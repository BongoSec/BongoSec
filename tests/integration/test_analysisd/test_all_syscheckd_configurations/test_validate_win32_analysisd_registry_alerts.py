...
brief: The 'bongosec-analysisd' daemon receives the log messages and compares them to the rules.
       ...
       Specifically, these tests will verify if the 'bongosec-analysisd' daemon generates valid
...
from bongosec_testing.modules.analysisd import patterns, utils, configuration as analysisd_config
...
monitored_sockets_params = [(BONGOSEC_DB_DAEMON, None, None), (ANALYSISD_DAEMON, mitm_analysisd, True)]
...
def test_validate_all_win32_registry_alerts(test_metadata, configure_local_internal_options, truncate_monitored_files_module,
    ...
    '''
    description: Check if the alerts generated by the 'bongosec-analysisd' daemon from Windows registry-related

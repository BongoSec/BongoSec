...
def test_rules_triggers_ar(test_configuration, test_metadata, truncate_monitored_files, set_bongosec_configuration,
    ...
    test_phases:
        - setup:
            - Copy custom rule and active response files to Bongosec paths.
            - Create a new file which will be monitored with logcollector.
            - Set bongosec configuration (add active_response command and localfile blocks).
        ...
        - teardown:
            ...
            - Restart initial bongosec configuration.

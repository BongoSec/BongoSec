...
from bongosec_testing.constants.paths.configurations import BONGOSEC_CLIENT_KEYS_PATH, DEFAULT_AUTHD_PASS_PATH
from bongosec_testing.tools.simulators.authd_simulator import AuthdSimulator
from bongosec_testing.utils.file import write_file, remove_file
...
def set_keys(test_metadata):
    ...
    for key in test_metadata.get('pre_existent_keys', []):
        write_file(BONGOSEC_CLIENT_KEYS_PATH, key)

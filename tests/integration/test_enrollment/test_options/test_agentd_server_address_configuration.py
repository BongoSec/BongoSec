...
references:
    - https://documentation.bongosec.github.io/current/user-manual/reference/ossec-conf/client.html#address
...
from bongosec_testing.modules.agentd.patterns import ENROLLMENT_INVALID_SERVER, ENROLLMENT_RESOLVE_ERROR, ENROLLMENT_CONNECTED
...
def test_agentd_server_address_configuration(test_configuration, test_metadata, set_bongosec_configuration, configure_local_internal_options,

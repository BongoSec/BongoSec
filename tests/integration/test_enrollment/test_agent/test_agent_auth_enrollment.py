...
from bongosec_testing.utils.sockets import get_host_name
...
cases_path = Path(TEST_CASES_PATH, 'cases_bongosec_agent_auth.yaml')
config_path = Path(CONFIGS_PATH, 'config_bongosec_agent_auth.yaml')
...
def test_agent_auth_enrollment(test_configuration, test_metadata, set_bongosec_configuration, daemons_handler_module,

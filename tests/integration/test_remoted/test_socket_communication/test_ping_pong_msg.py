...
from bongosec_testing.tools.simulators.agent_simulator import send_ping_pong_messages
...
def test_ping_pong_message(test_configuration, test_metadata, configure_local_internal_options, truncate_monitored_files,
                            set_bongosec_configuration, restart_bongosec_expect_error, protocols_list_to_str_upper_case):

    '''
    description: Check if 'bongosec-remoted' sends the #pong message

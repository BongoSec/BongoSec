...
from bongosec_testing.utils.sockets import send_active_response_message
...
def test_active_response_ar_sending(test_configuration, test_metadata, configure_local_internal_options, truncate_monitored_files,
    ...
    '''
    description: Check if the 'bongosec-remoted' daemon sends active response commands to the Bongosec agent.

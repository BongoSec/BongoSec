...
def test_connection_valid(test_configuration, test_metadata, configure_local_internal_options, truncate_monitored_files,
                            set_bongosec_configuration, restart_bongosec_expect_error, protocols_list_to_str_upper_case, get_real_configuration):

    '''
    description: Check if 'bongosec-remoted' sets 'connection' as 'secure' or 'syslog' properly.

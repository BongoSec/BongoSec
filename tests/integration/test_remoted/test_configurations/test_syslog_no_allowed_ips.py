...
from bongosec_testing.utils.network import format_ipv6_long
...
def test_syslog_no_allowed_ips(test_configuration, test_metadata, configure_local_internal_options, truncate_monitored_files,
                            set_bongosec_configuration, restart_bongosec_expect_error):

    '''
    description: Check that 'bongosec-remoted' fails when 'allowed-ips' is not provided but syslog connection is used.

...
from bongosec_testing.utils.network import format_ipv6_long, TCP, UDP
from bongosec_testing.utils.sockets import send_message_to_syslog_socket
from bongosec_testing.modules.api import utils
...
def test_denied_ips_syslog(test_configuration, test_metadata, configure_local_internal_options, truncate_monitored_files,
                            set_bongosec_configuration, restart_bongosec_expect_error, get_real_configuration):

    '''
    description: Check that 'bongosec-remoted' denied connection to the specified 'denied-ips'.

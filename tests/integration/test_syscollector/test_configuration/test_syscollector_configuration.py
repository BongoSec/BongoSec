...
brief: Bongosec gathers information about the agent system (OS, hardware, packages, etc.) periodically in a DB and sends
...
references:
    - https://documentation.bongosec.github.io/current/user-manual/capabilities/syscollector.html
    - https://documentation.bongosec.github.io/current/user-manual/reference/ossec-conf/wodle-syscollector.html
'''
import sys
...
from bongosec_testing.utils import services
from bongosec_testing.tools.monitors import file_monitor
from bongosec_testing.utils import callbacks, configuration
...
from bongosec_testing.modules.modulesd.syscollector import patterns
...
def test_syscollector_deactivation(test_configuration, test_metadata, set_bongosec_configuration,
    ...
    test_phases:
        ...
        - teardown:
            - Restore Bongosec configuration.
    ...
    parameters:
        ...
        - set_bongosec_configuration:
            type: fixture
            brief: Set bongosec configuration using the configuration template.
        ...
        - daemons_handler:
            type: fixture
            brief: Handler of Bongosec daemons for each test case.
...
def test_syscollector_all_scans_disabled(test_configuration, test_metadata, set_bongosec_configuration,
                                         configure_local_internal_options, truncate_monitored_files,
                                         daemons_handler):
    '''
...
def test_syscollector_invalid_configurations(test_configuration, test_metadata, set_bongosec_configuration,
                                             configure_local_internal_options, truncate_monitored_files,
                                             daemons_handler):
    '''
...
def test_syscollector_default_values(test_configuration, test_metadata, set_bongosec_configuration,
                                     configure_local_internal_options, truncate_monitored_files,
                                     daemons_handler):
    '''
...
def test_syscollector_scanning(test_configuration, test_metadata, set_bongosec_configuration,
                               configure_local_internal_options, truncate_monitored_files,
                               daemons_handler):
    '''

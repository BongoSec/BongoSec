...
def test_agentd_reconection_enrollment_no_keys(test_metadata, set_bongosec_configuration, configure_local_internal_options, truncate_monitored_files, clean_keys, daemons_handler):
    '''

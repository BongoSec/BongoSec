...
def test_agentd_reconection_enrollment_no_keys_file(test_metadata, set_bongosec_configuration, configure_local_internal_options, truncate_monitored_files, remove_keys_file, daemons_handler):
    '''
    description: Check how the agent behaves when losing communication with
                 the 'bongosec-remoted' daemon and a new enrollment is sent to
                 the 'bongosec-authd' daemon.

...
brief: These tests will check if the 'rbac_mode' (Role-Based Access Control) setting of the API
       ...
       'whitelist mode' and 'blacklist mode'. The Bongosec API is an open source 'RESTful' API
       that allows for interaction with the Bongosec manager from a web browser, command line tool
...
references:
    ...
    - https://documentation.bongosec.github.io/current/user-manual/api/configuration.html#rbac-mode
...
from bongosec_testing.constants.api import CONFIGURATION_TYPES, MANAGER_INFORMATION_ROUTE

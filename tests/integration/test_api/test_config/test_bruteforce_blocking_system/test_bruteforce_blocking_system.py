...
brief: These tests will check if the IP blocking feature of the API handled by the 'bongosec-apid' daemon
       is working properly. The Bongosec API is an open source 'RESTful' API that allows for interaction
...
references:
    ...
    - https://documentation.bongosec.github.io/current/user-manual/api/configuration.html#access
...
from bongosec_testing.modules.api.patterns import API_LOGIN_ERROR_MSG
from bongosec_testing.modules.api.utils import login

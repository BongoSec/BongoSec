...
brief: These tests will check if the 'DOS' (Denial-of-service attack) blocking feature of the API handled
       by the 'bongosec-apid' daemon is working properly. The Bongosec API is an open source 'RESTful' API
...
from bongosec_testing.constants.api import CONFIGURATION_TYPES, AGENTS_ROUTE

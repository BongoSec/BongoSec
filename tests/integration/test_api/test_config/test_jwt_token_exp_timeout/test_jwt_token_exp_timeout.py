...
brief: These tests will check if the 'auth_token_exp_timeout' setting of the API is working properly.
       ...
       The Bongosec API is an open source 'RESTful' API that allows for interaction with the Bongosec manager
...
references:
    ...
    - https://documentation.bongosec.github.io/current/user-manual/api/configuration.html#auth-token-exp-timeout

...
from . import BONGOSEC_PYTHON_INTERPRETER_PATH, MOCK_SERVER_PATH, MOCK_SERVER_IMAGE, MOCK_SERVER_CONTAINER
...
def disable_ssl_verification():
    """Modify bongosec/core/utils.py to avoid SSL certificate verification."""
    file_path = Path(BONGOSEC_PYTHON_INTERPRETER_PATH, '/bongosec/core/utils.py')

...
def test_upload_configuration(test_configuration, test_metadata, backup_bongosec_configuration, add_configuration,
    ...
    parameters:
        ...
        - backup_bongosec_configuration:
            type: fixture
            brief: Save the initial bongosec configuration and restore it after the test.
        - add_configuration:
            type: fixture

...
brief: These tests will check if the set_secure_headers middleware of the API handled by the 'bongosec-apid' daemon is
       working properly. The Bongosec API is an open source 'RESTful' API that allows for interaction with the Bongosec
...
from bongosec_testing.constants.api import AGENTS_ROUTE, CONFIGURATION_TYPES

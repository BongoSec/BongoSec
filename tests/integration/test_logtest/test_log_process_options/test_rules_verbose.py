...
def test_rules_verbose(test_metadata, daemons_handler_module, configure_rules_list,
    ...
    '''
    description: Check if 'bongosec-logtest' works correctly in 'verbose' mode for rules debugging. To do this, it sends
    ...
    parameters:
        ...
        - configure_rules_list:
            type: fixture
            brief: Configure a custom rules for testing. Restart Bongosec is not needed for applying the configuration
                   is optional.

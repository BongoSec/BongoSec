...
references:
    ...
    - https://documentation.bongosec.github.io/current/user-manual/ruleset/cdb-list.html
...
def test_cdb_list(test_configuration, test_metadata, set_bongosec_configuration,

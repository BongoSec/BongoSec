...
import pytest
from bongosec_testing.constants.paths.sockets import ANALYSISD_ANALISIS_SOCKET_PATH
...
def test_get_configuration_sock(test_configuration, test_metadata, set_bongosec_configuration,
    ...
    description: Check analysis Unix socket returns the correct Logtest configuration under different sets of
                 configurations, `bongosec-analisysd` returns the right information from the `rule_test` configuration
                 ...
                 that the loaded fields from the 'bongosec_conf.yaml' file.

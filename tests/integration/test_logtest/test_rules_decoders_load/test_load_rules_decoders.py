...
references:
    ...
    - https://documentation.bongosec.github.io/current/user-manual/ruleset/testing.html?highlight=logtest
    - https://documentation.bongosec.github.io/current/user-manual/capabilities/bongosec-logtest/logtest-configuration.html
...
from bongosec_testing.constants.daemons import ANALYSISD_DAEMON, BONGOSEC_DB_DAEMON
...
daemons_handler_configuration = {'daemons': [ANALYSISD_DAEMON, BONGOSEC_DB_DAEMON]}
...
def test_load_rules_decoders(test_metadata, daemons_handler_module, wait_for_logtest_startup,
    ...
    '''
    description: Check if 'bongosec-logtest' does produce the right decoder/rule matching when processing a log under
    ...
    parameters:
        - daemons_handler_module:
            type: fixture
            brief: Bongosec logtests daemons handler.

...
# Bongosec module: Github architecture
## Index
1. [Purpose](#purpose)
...
Bongosec has the ability to obtain and process Github audit log through:
- Github module

## Sequence Diagram
Sequence diagram shows the basic flow of Bongosec Github integration based on the configuration provided. Steps are:
...
5. Insert events into bongosec DB.

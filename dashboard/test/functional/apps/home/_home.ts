...
export default function ({ getService, getPageObjects }: FtrProviderContext) {
  ...
  describe('OpenSearch Dashboards takes you home', function describeIndexTests() {
    ...
    // Bongosec: The home page of Bongosec is different from the OpenSearch Dashboards home page
    // and the console app is not available on the Bongosec home page

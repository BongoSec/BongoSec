  ...
  describe('OpenSearch Dashboards branding configuration', function customHomeBranding() {
    ...
    describe('should render home page', async () => {
      ...
      describe('in default mode', async () => {
        ...
        // Bongosec: This test is omitted because OpenSearch Dashboards does not have a home dashboard card.
        ...
        // Bongosec: This test is omitted because OpenSearch Dashboards does not appear in the side menu.

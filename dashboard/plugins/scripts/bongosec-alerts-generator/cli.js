(function () {
  ...
  const cliName = 'Bongosec alerts generator';
  const cliDescription = 'Generates sample data of Bongosec alerts';
  ...
  const defaultConfiguration = {
    ...
    alertGenerationParams: {
      ...
      cluster: {
        name: 'bongosec-cluster',
        node: 'bongosec-manager',
      },
    },
  };
...
- Generate alerts for all the modules in OpenSearch/Elasticsearch Bulk API format to a bongosec-alerts index and save to a output.ndjson file
node ${cliFilePath} --all-modules --format bulk-api --index bongosec-alerts > output.ndjson

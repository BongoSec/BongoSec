...
This script generates random events with the Vulnerabilities format and saves them to a file or injects them to a Bongosec-Indexer/Opensearch instance.

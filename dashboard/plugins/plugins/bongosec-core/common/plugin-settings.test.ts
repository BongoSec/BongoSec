...
describe('[settings] Input validation', () => {
  it.each`
    ...
    ${'timeout'}                        | ${1.2}                                                                 | ${'Number should be an integer.'}
    ${'bongosec.monitoring.creation'}      | ${'h'}                                                                 | ${undefined}
    ${'bongosec.monitoring.creation'}      | ${'d'}                                                                 | ${undefined}
    ${'bongosec.monitoring.creation'}      | ${'w'}                                                                 | ${undefined}
    ${'bongosec.monitoring.creation'}      | ${'m'}                                                                 | ${undefined}
    ${'bongosec.monitoring.creation'}      | ${'test'}                                                              | ${'Invalid value. Allowed values: h, d, w, m.'}
    ${'bongosec.monitoring.enabled'}       | ${true}                                                                | ${undefined}
    ${'bongosec.monitoring.frequency'}     | ${100}                                                                 | ${undefined}
    ${'bongosec.monitoring.frequency'}     | ${40}                                                                  | ${'Value should be greater or equal than 60.'}
    ${'bongosec.monitoring.frequency'}     | ${'1.2'}                                                               | ${'Number should be an integer.'}
    ${'bongosec.monitoring.frequency'}     | ${1.2}                                                                 | ${'Number should be an integer.'}
    ${'bongosec.monitoring.pattern'}       | ${'test'}                                                              | ${undefined}
    ${'bongosec.monitoring.pattern'}       | ${'test*'}                                                             | ${undefined}
    ${'bongosec.monitoring.pattern'}       | ${''}                                                                  | ${'Value can not be empty.'}
    ${'bongosec.monitoring.pattern'}       | ${'-test'}                                                             | ${"It can't start with: -, _, +, .."}
    ${'bongosec.monitoring.pattern'}       | ${'_test'}                                                             | ${"It can't start with: -, _, +, .."}
    ${'bongosec.monitoring.pattern'}       | ${'+test'}                                                             | ${"It can't start with: -, _, +, .."}
    ${'bongosec.monitoring.pattern'}       | ${'.test'}                                                             | ${"It can't start with: -, _, +, .."}
    ${'bongosec.monitoring.pattern'}       | ${'test\\'}                                                            | ${'It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'bongosec.monitoring.pattern'}       | ${'test/'}                                                             | ${'It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'bongosec.monitoring.pattern'}       | ${'test?'}                                                             | ${'It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'bongosec.monitoring.pattern'}       | ${'test"'}                                                             | ${'It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'bongosec.monitoring.pattern'}       | ${'test<'}                                                             | ${'It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ...
    ${'bongosec.monitoring.pattern'}       | ${'test,'}                                                             | ${'It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'bongosec.monitoring.pattern'}       | ${'test#'}                                                             | ${'It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'bongosec.monitoring.replicas'}      | ${0}                                                                   | ${undefined}
    ${'bongosec.monitoring.replicas'}      | ${-1}                                                                  | ${'Value should be greater or equal than 0.'}
    ${'bongosec.monitoring.replicas'}      | ${'1.2'}                                                               | ${'Number should be an integer.'}
    ${'bongosec.monitoring.replicas'}      | ${1.2}                                                                 | ${'Number should be an integer.'}
    ${'bongosec.monitoring.shards'}        | ${1}                                                                   | ${undefined}
    ${'bongosec.monitoring.shards'}        | ${-1}                                                                  | ${'Value should be greater or equal than 1.'}
    ${'bongosec.monitoring.shards'}        | ${'1.2'}                                                               | ${'Number should be an integer.'}
    ${'bongosec.monitoring.shards'}        | ${1.2}                                                                 | ${'Number should be an integer.'}

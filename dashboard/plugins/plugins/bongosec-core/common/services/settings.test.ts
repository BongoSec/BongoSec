...
describe('[settings] Methods', () => {
  ...
  //     ${true}              | ${'customization.reports.footer'} | ${''}                     | ${'Copyright © 2023 Bongosec, Inc.'}
  //     ${false}             | ${'customization.reports.footer'} | ${'Custom footer'}        | ${'Copyright © 2023 Bongosec, Inc.'}
  //     ${false}             | ${'customization.reports.footer'} | ${''}                     | ${'Copyright © 2023 Bongosec, Inc.'}
  //     ${false}             | ${'customization.reports.footer'} | ${''}                     | ${'Copyright © 2023 Bongosec, Inc.'}
  //     ${true}              | ${'customization.reports.header'} | ${'Custom header'}        | ${'Custom header'}
  //     ${true}              | ${'customization.reports.header'} | ${''}                     | ${'info@bongosec.github.io\nhttps://bongosec.github.io'}
  //     ${false}             | ${'customization.reports.header'} | ${'Custom header'}        | ${'info@bongosec.github.io\nhttps://bongosec.github.io'}
  //     ${false}             | ${'customization.reports.header'} | ${''}                     | ${'info@bongosec.github.io\nhttps://bongosec.github.io'}
  //   `(

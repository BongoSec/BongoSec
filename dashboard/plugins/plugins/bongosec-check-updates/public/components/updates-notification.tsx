...
import { getCore, getBongosecCore } from '../plugin-services';
import { AvailableUpdates } from '../../../bongosec-check-updates/common/types';
...
export const UpdatesNotification = () => {
  ...
  const sideNavDocked = getBongosecCore().hooks.useDockedSideNav();
          ...
          <EuiFlexItem grow={false}>
            <EuiFlexGroup gutterSize='m' alignItems='center'>
              <EuiFlexItem grow={false} style={{ maxWidth: 'max-content' }}>
                <EuiText>
                  <FormattedMessage
                    id='bongosecCheckUpdates.updatesNotification.message'
              ...
              <EuiFlexItem grow={false} style={{ maxWidth: 'max-content' }}>
                <RedirectAppLinks application={getCore().application}>
                  ...
                  >
                    <FormattedMessage
                      id='bongosecCheckUpdates.updatesNotification.linkText'
            ...
            <EuiFlexGroup gutterSize='m' alignItems='center'>
              <EuiFlexItem grow={false}>
                <EuiCheckbox
                  ...
                  label={
                    <FormattedMessage
                      id='bongosecCheckUpdates.updatesNotification.dismissCheckText'
              ...
              <EuiFlexItem grow={false} style={{ maxWidth: 'max-content' }}>
                ...
                >
                  <FormattedMessage
                    id='bongosecCheckUpdates.updatesNotification.closeButtonText'

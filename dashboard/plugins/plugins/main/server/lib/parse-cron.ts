/*
 * Bongosec app - Module to transform seconds interval to cron readable format
...
import { BONGOSEC_MONITORING_DEFAULT_CRON_FREQ } from '../../common/constants';
...
export function parseCron(interval: string) {
  try {
    ...
    return BONGOSEC_MONITORING_DEFAULT_CRON_FREQ;
  }
}

...
module.exports.data = [
  ...
  },
  {
    ...
    decoder: DECODER.WEB_ACCESSLOG,
    full_log:
      '{data.srcip} - - [{_date}] "{data.protocol} {data.url} HTTP/1.1" {data.id} 222 "-" "{_user_agent}"',
    location: '/var/log/httpd/access_log',
  },
];

...
module.exports.insecureConnectionAttempt = {
  ...
  full_log:
    '{predecoder.timestamp} {predecoder.hostname} sshd[15225]: Did not receive identification string from {data.srcip} port {data.srcport}',
  location: '/var/log/secure',
};

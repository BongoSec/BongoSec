/*
 * Bongosec app - FIM sample alerts
...
module.exports.pathsLinux = [
  '/etc/resolv.conf',
  '/var/bongosec/queue/fim/db/fim.db-journal',
  '/var/bongosec/queue/fim/db/fim.db',
...
module.exports.pathsWindows = [
  ...
  'c:\\program files (x86)\\bongosec-agent\\wodles\\syscollector',
  'c:\\program files (x86)\\bongosec-agent\\rids\\sender_counter',
  'c:\\program files (x86)\\bongosec-agent\\queue\\fim\\db\\fim.db',
  'c:\\program files (x86)\\bongosec-agent\\bongosec-agent.state',

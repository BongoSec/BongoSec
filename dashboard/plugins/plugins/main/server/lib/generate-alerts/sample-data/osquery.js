/*
 * Bongosec app - Osquery sample alerts
...
module.exports.dataOsquery = [
  {
    ...
    rule: {
      ...
      level: 4,
      description:
        'osquery: osquery-monitoring osquery_info: Osquery version is 3.3.2 build on ubuntu xenial',
    },
  },
  {
    osquery: {
    ...
    rule: {
      ...
      level: 4,
      description:
        'osquery: incident-response iptables: Iptable source ip 172.17.0.0 with policy ACCEPT and target MASQUERADE has a packet count of 43092',
    },
  },
  {
    osquery: {
    ...
    rule: {
      ...
      level: 4,
      description:
        'osquery: incident-response iptables: Iptable source ip 0.0.0.0 with policy ACCEPT and target DOCKER has a packet count of 34553',
    },
  },
  {
    osquery: {
    ...
    rule: {
      ...
      level: 4,
      description:
        'osquery: osquery-monitoring schedule: The pack executed is pack_ossec-rootkit_zk_rootkit and the interval is 3600 ',
    },
  },
  {
    osquery: {
  ...
  },
  {
    ...
    rule: {
      ...
      level: 4,
      description:
        'osquery: incident-response process_memory: Process 644 [vsyscall] memory start 0xffffffffff600000, memory end 0xffffffffff601000',
    },
  },
  {
    osquery: {
    ...
    rule: {
      ...
      level: 4,
      description:
        'osquery: incident-response iptables: Iptable source ip 172.17.0.0 with policy ACCEPT and target MASQUERADE has a packet count of 43294',
    },
  },
  {
    osquery: {
    ...
    rule: {
      ...
      level: 4,
      description:
        'osquery: incident-response process_env: Process 26151 Environment variable GENERATION value 244',
    },
  },
  {
    osquery: {
    ...
    rule: {
      ...
      level: 4,
      description:
        'osquery: hardware-monitoring device_nodes: Device /dev/ptmx, UID 0, GID 5, type character',
    },
  },
  {
    osquery: {
  ...
  },
  {
    ...
    rule: {
      ...
      level: 4,
      description:
        'osquery: incident-response open_files: Process 18631 has file /var/osquery/osquery.db/MANIFEST-016679 opened',
    },
  },
];

/*
 * Bongosec app - Docker sample data
...
module.exports.actorAttributesImage = [
  'bongosec/bongosec:3.12.0-7.6.1',
...
module.exports.dataDocker = [
  ...
  },
  {
    rule: {
      level: 3,
      description: 'Docker: Image or repository bongosec/bongosec pulled',
      id: '87932',
      firedtimes: 1,
      mail: false,
      groups: ['docker'],
    ...
    data: {
      ...
      docker: {
        status: 'pull',
        id: 'bongosec/bongosec:3.9.2_7.1.1',
        Type: 'image',
        Action: 'pull',
        Actor: {
          ID: 'bongosec/bongosec:3.9.2_7.1.1',
          Attributes: {
            name: 'bongosec/bongosec',
          },
        },
        scope: 'local',
        time: '1563354346',
  ...
  },
  {
    rule: {
      level: 3,
      description:
        'Docker: Image or repository bongosec/bongosec-elasticsearch pulled',
      id: '87932',
      firedtimes: 2,
      mail: false,
      groups: ['docker'],
    ...
    data: {
      ...
      docker: {
        status: 'pull',
        id: 'bongosec/bongosec-elasticsearch:3.9.2_7.1.1',
        Type: 'image',
        Action: 'pull',
        Actor: {
          ID: 'bongosec/bongosec-elasticsearch:3.9.2_7.1.1',
          Attributes: {
            ...
            name: 'bongosec/bongosec-elasticsearch',
            org: {
              'label-schema': {
                'build-date': '20190305',
                license: 'GPLv2',
  ...
  },
  {
    rule: {
      level: 3,
      description: 'Docker: Image or repository bongosec/bongosec-kibana pulled',
      id: '87932',
      firedtimes: 3,
      mail: false,
      groups: ['docker'],
    ...
    data: {
      ...
      docker: {
        status: 'pull',
        id: 'bongosec/bongosec-kibana:3.9.2_7.1.1',
        Type: 'image',
        Action: 'pull',
        Actor: {
          ID: 'bongosec/bongosec-kibana:3.9.2_7.1.1',
  ...
  },
  {
    rule: {
      level: 3,
      description: 'Docker: Image or repository bongosec/bongosec-nginx pulled',
      id: '87932',
      firedtimes: 3,
      mail: false,
      groups: ['docker'],
    ...
    data: {
      ...
      docker: {
        status: 'pull',
        id: 'bongosec/bongosec-nginx:3.9.2_7.1.1',
        Type: 'image',
        Action: 'pull',
        Actor: {
          ID: 'bongosec/bongosec-nginx:3.9.2_7.1.1',
  ...
  },
  {
    ...
    data: {
      ...
      docker: {
        ...
        Actor: {
          Attributes: {
            container: Random.createHash(64),
            name: 'bridge',
            type: 'bridge',
          },
          ID: Random.createHash(64),
  ...
  },
  {
    rule: {
      ...
      level: 7,
      description:
        'Docker: Container nginx_container received the action: kill',
      groups: ['docker'],
      id: '87924',
      gdpr: ['IV_32.2'],
    },

/*
 * Bongosec app - Policy monitoring sample alerts
...
module.exports.trojansData = {
  ...
  full_log:
    "Trojaned version of file '{data.file}' detected. Signature used: '{_trojan_signature}' (Generic).",
};

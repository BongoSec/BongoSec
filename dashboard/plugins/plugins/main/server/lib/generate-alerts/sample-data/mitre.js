/*
 * Bongosec app - Mitre sample alerts
...
module.exports.arrayMitreRules = [
  ...
  },
  {
    ...
    level: 7,
    status: 'enabled',
    details: { category: 'bongosec', decoded_as: 'syscheck_integrity_changed' },
    pci_dss: ['11.5'],
    gpg13: ['4.11'],
    gdpr: ['II_5.1.f'],
  ...
  },
  {
    ...
    level: 7,
    status: 'enabled',
    details: { category: 'bongosec', decoded_as: 'syscheck_deleted' },
    pci_dss: ['11.5'],
    gpg13: ['4.11'],
    gdpr: ['II_5.1.f'],
    hipaa: ['164.312.c.1', '164.312.c.2'],
  ...
  },
  {
    ...
    groups: ['spam', 'syslog', 'sendmail'],
    description:
      'sendmail: Rejected by access list (55x: Requested action not taken).',
  },
  {
    filename: '0025-sendmail_rules.xml',
    relative_dirname: 'ruleset/rules',
    ...
    groups: ['spam', 'syslog', 'sendmail'],
    description:
      'sendmail: Attempt to use mail server as relay (550: Requested action not taken).',
  },
  {
    filename: '0025-sendmail_rules.xml',
    relative_dirname: 'ruleset/rules',
    ...
    groups: ['spam', 'syslog', 'sendmail'],
    description:
      'sendmail: Sender domain is not found  (553: Requested action not taken).',
  },
  {
    filename: '0025-sendmail_rules.xml',
    relative_dirname: 'ruleset/rules',
    ...
    groups: ['spam', 'syslog', 'sendmail'],
    description:
      'sendmail: Sender address does not have domain (553: Requested action not taken).',
  },
  {
    filename: '0025-sendmail_rules.xml',
    relative_dirname: 'ruleset/rules',
  ...
  },
  {
    ...
    description:
      'sendmail: Sender domain has bogus MX record. It should not be sending e-mail.',
  },
  {
    filename: '0025-sendmail_rules.xml',
    relative_dirname: 'ruleset/rules',
  ...
  },
  {
    ...
    groups: ['multiple_spam', 'syslog', 'sendmail'],
    description:
      'sendmail: Multiple attempts to send e-mail from invalid/unknown sender.',
  },
  {
    filename: '0025-sendmail_rules.xml',
    relative_dirname: 'ruleset/rules',
  ...
  },
  {
    ...
    description:
      'sendmail: SMF-SAV sendmail milter unable to verify address (REJECTED).',
  },
  {
  ...
  },
  {
    ...
    groups: ['spam', 'syslog', 'postfix'],
    description:
      'Postfix: Sender domain is not found (450: Requested mail action not taken).',
  },
  {
    filename: '0030-postfix_rules.xml',
    relative_dirname: 'ruleset/rules',
  ...
  },
  {
    ...
    groups: ['multiple_spam', 'syslog', 'postfix'],
    description:
      'Postfix: Multiple attempts to send e-mail from a rejected sender IP (access).',
  },
  {
    filename: '0030-postfix_rules.xml',
    relative_dirname: 'ruleset/rules',
    ...
    groups: ['multiple_spam', 'syslog', 'postfix'],
    description:
      'Postfix: Multiple attempts to send e-mail from invalid/unknown sender domain.',
  },
  {
    filename: '0030-postfix_rules.xml',
    relative_dirname: 'ruleset/rules',
  ...
  },
  {
    ...
    groups: ['netscreenfw'],
    description:
      'Netscreen firewall: Multiple critical messages from same source IP.',
  },
  {
    filename: '0070-netscreenfw_rules.xml',
    relative_dirname: 'ruleset/rules',
  ...
  },
  {
    ...
    groups: ['syslog', 'telnetd'],
    description:
      'telnetd: Multiple connection attempts from same source (possible scan).',
  },
  {
  ...
  },
  {
    ...
    groups: ['syslog', 'sshd'],
    description:
      'sshd: Possible scan or breakin attempt (high number of login timeouts).',
  },
  {
    filename: '0095-sshd_rules.xml',
    relative_dirname: 'ruleset/rules',

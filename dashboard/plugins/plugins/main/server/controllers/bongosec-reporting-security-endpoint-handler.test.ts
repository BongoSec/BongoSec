import md5 from 'md5';
import fs from 'fs';
import { BongosecReportingCtrl } from './bongosec-reporting';
...
const endpointController = new BongosecReportingCtrl();
...
describe('[security] Report endpoints guard related to a file. Parameter defines or builds the filename.', () => {
  ...
  it.each`
    ...
    ${'Execute endpoint handler'} | ${'admin'}     | ${'bongosec-module-overview-general-1234.pdf'}          | ${false}
    ${'Endpoint protected'}       | ${'admin'}     | ${'../bongosec-module-overview-general-1234.pdf'}       | ${true}
    ${'Endpoint protected'}       | ${'admin'}     | ${'bongosec-module-overview-../general-1234.pdf'}       | ${true}
    ${'Endpoint protected'}       | ${'admin'}     | ${'custom../bongosec-module-overview-general-1234.pdf'} | ${true}
    ${'Execute endpoint handler'} | ${'../../etc'} | ${'bongosec-module-agents-001-general-1234.pdf'}        | ${false}
    ${'Endpoint protected'}       | ${'../../etc'} | ${'../bongosec-module-agents-001-general-1234.pdf'}     | ${true}
    ${'Endpoint protected'}       | ${'../../etc'} | ${'bongosec-module-overview-../general-1234.pdf'}       | ${true}
    ${'Endpoint protected'}       | ${'../../etc'} | ${'custom../bongosec-module-overview-general-1234.pdf'} | ${true}
  `(
    `$testTitle
	username: $username
	filename: $filename
...
describe('[security] GET /reports/{name}', () => {
  it.each`
    ...
    ${'Get report'}         | ${'admin'}     | ${'bongosec-module-overview-1234.pdf'}    | ${true}
    ${'Endpoint protected'} | ${'admin'}     | ${'../bongosec-module-overview-1234.pdf'} | ${false}
    ${'Get report'}         | ${'../../etc'} | ${'bongosec-module-overview-1234.pdf'}    | ${true}
    ${'Endpoint protected'} | ${'../../etc'} | ${'../bongosec-module-overview-1234.pdf'} | ${false}
  `(
    ...
    async ({ username, moduleID, valid }) => {
      ...
      if (valid) {
        ...
        expect(response.body.message).toMatch(
          new RegExp(`Report bongosec-module-overview-${moduleID}`),
        );
      } else {
        expect(response.body.message).toBe('5040 - You shall not pass!');
      }
...
describe('[security] DELETE /reports/<filename>', () => {
  ...
  it.each`
    titleTest               | username       | filename                                     | valid
    ${'Delete report'}      | ${'admin'}     | ${'bongosec-module-overview-1234.pdf'}          | ${true}
    ${'Endpoint protected'} | ${'admin'}     | ${'../bongosec-module-overview-1234.pdf'}       | ${false}
    ${'Endpoint protected'} | ${'admin'}     | ${'custom../bongosec-module-overview-1234.pdf'} | ${false}
    ${'Delete report'}      | ${'../../etc'} | ${'bongosec-module-overview-1234.pdf'}          | ${true}
    ${'Endpoint protected'} | ${'../../etc'} | ${'../bongosec-module-overview-1234.pdf'}       | ${false}
    ${'Endpoint protected'} | ${'../../etc'} | ${'custom../bongosec-module-overview-1234.pdf'} | ${false}
  `(

// To launch this file
// yarn test:jest --testEnvironment node --verbose server/routes/bongosec-api
...
describe.skip('Bongosec API', () => {
  describe('Bongosec API - /api/login', () => {
  ...
  describe('Bongosec API - /api/check-api', () => {
      ...
      return axios(options).catch(error => {
        ...
        expect(
          error.response.data.message.includes(
            'Selected API is no longer available in bongosec.yml',
          ),
        ).toBe(true);
      });
    });
  ...
  describe('Bongosec API - /api/check-stored-api', () => {
    test('[200] Check default api returns manager, node, cluster, status and allow_run_as params', () => {
  ...
  describe('Bongosec API - /api/request', () => {
    let userToken = null;
    beforeAll(() => {
  ...
  describe('Bongosec API - /api/routes', () => {
  ...
  describe('Bongosec API - /api/setup', () => {
  ...
  describe('Bongosec API - /api/syscollector', () => {

/*
 * Bongosec app - Module for Bongosec-Elastic routes
 ...
 */
import { BongosecElasticCtrl } from '../controllers';
...
export function BongosecElasticRoutes(router: IRouter) {
  const ctrl = new BongosecElasticCtrl();

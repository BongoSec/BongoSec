/*
 * Bongosec app - Module for Bongosec reporting routes
 ...
 */
import { BongosecReportingCtrl } from '../controllers';
import { IRouter } from 'opensearch_dashboards/server';
import { schema } from '@osd/config-schema';

export function BongosecReportingRoutes(router: IRouter) {
  const ctrl = new BongosecReportingCtrl();

// To launch this file
// yarn test:jest --testEnvironment node --verbose server/routes/bongosec-elastic
...
describe.skip('Bongosec Elastic', () => {
  describe('Bongosec API - /elastic/security/current-platform', () => {
  ...
  // describe('Bongosec API - /elastic/visualizations/{tab}/{pattern}', () => {
  ...
  describe('Bongosec API - /elastic/template/{pattern}', () => {
    test('[200] Check if there is some template with the pattern', () => {
      const options = buildAxiosOptions(
        'get',
        '/elastic/template/bongosec-alerts-*',
      );
      return axios(options).then(response => {
        expect(response.status).toBe(200);
  ...
  // TODO: This test need to be defined
  // describe('Bongosec API - /elastic/top/{mode}/{cluster}/{field}/{pattern}', () => {
  ...
  describe('Bongosec API - /elastic/samplealerts', () => {
  ...
  describe('Bongosec API - /elastic/samplealerts/{category}', () => {
  ...
  // TODO: This test need to be defined
  // describe('Bongosec API - /elastic/alerts', () => {
  //   test('[200] Check if there an sample data index of Security category', () => {

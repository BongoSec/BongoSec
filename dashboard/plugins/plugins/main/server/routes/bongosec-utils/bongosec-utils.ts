/*
 * Bongosec app - Module for Bongosec utils routes
 ...
 */
import { BongosecUtilsCtrl } from '../../controllers';
...
export function BongosecUtilsRoutes(router: IRouter, services) {
  const ctrl = new BongosecUtilsCtrl();

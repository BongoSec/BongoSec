// To run this file:
// yarn test:jest --testEnvironment node --verbose server/routes/bongosec-utils
...
import { BongosecUtilsRoutes } from './bongosec-utils';
import fs from 'fs';
...
// Register settings
context.bongosec_core.configuration._settings.set('pattern', {
  validate: () => undefined,
...
beforeAll(async () => {
  ...
  // Register routes
  BongosecUtilsRoutes(router, { configuration: context.bongosec_core.configuration });
...
describe('[endpoint] PUT /utils/configuration - protected route', () => {
  ...
  `(
    ...
    async ({
      ...
      context.bongosec_core.configuration.get.mockReturnValueOnce(
        isConfigurationAPIEditable,
      );
      context.bongosec_core.dashboardSecurity.isAdministratorUser.mockReturnValueOnce(
        {
...
describe.skip('[endpoint] GET /utils/configuration', () => {
  it(`Get plugin configuration and ensure the hosts is not returned GET /utils/configuration - 200`, async () => {
    ...
    context.bongosec_core.configuration.get.mockReturnValueOnce(initialConfig);
    const response = await supertest(innerServer.listener)
...
describe.skip('[endpoint] PUT /utils/configuration', () => {
  beforeAll(() => {
    context.bongosec_core.configuration._settings = new Map();
    context.bongosec_core.configuration._settings.set('pattern', {
      isConfigurableFromSettings: true,
    });
    ...
    context.bongosec_core.configuration._settings.set('timeout', {
      isConfigurableFromSettings: true,
    });
    context.bongosec_core.configuration._settings.set('cron.statistics.apis', {
      isConfigurableFromSettings: true,
    });
  });
  ...
  afterAll(() => {
    ...
    context.bongosec_core.configuration._settings = null;
  });
  ...
  `(
    ...
    async ({ responseStatusCode, settings }) => {
      ...
      context.bongosec_core.configuration.get.mockReturnValueOnce(initialConfig);
      context.bongosec_core.configuration.set.mockReturnValueOnce(settings);
      const response = await supertest(innerServer.listener)
        .put('/utils/configuration')
        .send(settings)
        .expect(responseStatusCode);
  ...
  it.skip.each`
    ...
    ${'bongosec.monitoring.creation'}      | ${'h'}                                                           | ${200}             | ${null}
    ${'bongosec.monitoring.creation'}      | ${'d'}                                                           | ${200}             | ${null}
    ${'bongosec.monitoring.creation'}      | ${'w'}                                                           | ${200}             | ${null}
    ${'bongosec.monitoring.creation'}      | ${'m'}                                                           | ${200}             | ${null}
    ${'bongosec.monitoring.creation'}      | ${'test'}                                                        | ${400}             | ${'[request body.bongosec.monitoring.creation]: types that failed validation:\n- [request body.bongosec.monitoring.creation.0]: expected value to equal [h]\n- [request body.bongosec.monitoring.creation.1]: expected value to equal [d]\n- [request body.bongosec.monitoring.creation.2]: expected value to equal [w]\n- [request body.bongosec.monitoring.creation.3]: expected value to equal [m]'}
    ${'bongosec.monitoring.enabled'}       | ${true}                                                          | ${200}             | ${null}
    ${'bongosec.monitoring.enabled'}       | ${0}                                                             | ${400}             | ${'[request body.bongosec.monitoring.enabled]: expected value of type [boolean] but got [number]'}
    ${'bongosec.monitoring.frequency'}     | ${100}                                                           | ${200}             | ${null}
    ${'bongosec.monitoring.frequency'}     | ${40}                                                            | ${400}             | ${'[request body.bongosec.monitoring.frequency]: Value should be greater or equal than 60.'}
    ${'bongosec.monitoring.frequency'}     | ${1.2}                                                           | ${400}             | ${'[request body.bongosec.monitoring.frequency]: Number should be an integer.'}
    ${'bongosec.monitoring.frequency'}     | ${''}                                                            | ${400}             | ${'[request body.bongosec.monitoring.frequency]: expected value of type [number] but got [string]'}
    ${'bongosec.monitoring.pattern'}       | ${'test'}                                                        | ${200}             | ${null}
    ${'bongosec.monitoring.pattern'}       | ${'test*'}                                                       | ${200}             | ${null}
    ${'bongosec.monitoring.pattern'}       | ${''}                                                            | ${400}             | ${'[request body.bongosec.monitoring.pattern]: value has length [0] but it must have a minimum length of [1].'}
    ${'bongosec.monitoring.pattern'}       | ${true}                                                          | ${400}             | ${'[request body.bongosec.monitoring.pattern]: expected value of type [string] but got [boolean]'}
    ${'bongosec.monitoring.pattern'}       | ${'-test'}                                                       | ${400}             | ${"[request body.bongosec.monitoring.pattern]: It can't start with: -, _, +, .."}
    ${'bongosec.monitoring.pattern'}       | ${'_test'}                                                       | ${400}             | ${"[request body.bongosec.monitoring.pattern]: It can't start with: -, _, +, .."}
    ${'bongosec.monitoring.pattern'}       | ${'+test'}                                                       | ${400}             | ${"[request body.bongosec.monitoring.pattern]: It can't start with: -, _, +, .."}
    ${'bongosec.monitoring.pattern'}       | ${'.test'}                                                       | ${400}             | ${"[request body.bongosec.monitoring.pattern]: It can't start with: -, _, +, .."}
    ${'bongosec.monitoring.pattern'}       | ${'test\\'}                                                      | ${400}             | ${'[request body.bongosec.monitoring.pattern]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'bongosec.monitoring.pattern'}       | ${'test/'}                                                       | ${400}             | ${'[request body.bongosec.monitoring.pattern]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'bongosec.monitoring.pattern'}       | ${'test?'}                                                       | ${400}             | ${'[request body.bongosec.monitoring.pattern]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'bongosec.monitoring.pattern'}       | ${'test"'}                                                       | ${400}             | ${'[request body.bongosec.monitoring.pattern]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'bongosec.monitoring.pattern'}       | ${'test<'}                                                       | ${400}             | ${'[request body.bongosec.monitoring.pattern]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ...
    ${'bongosec.monitoring.pattern'}       | ${'test,'}                                                       | ${400}             | ${'[request body.bongosec.monitoring.pattern]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'bongosec.monitoring.pattern'}       | ${'test#'}                                                       | ${400}             | ${'[request body.bongosec.monitoring.pattern]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'bongosec.monitoring.replicas'}      | ${0}                                                             | ${200}             | ${null}
    ${'bongosec.monitoring.replicas'}      | ${-1}                                                            | ${400}             | ${'[request body.bongosec.monitoring.replicas]: Value should be greater or equal than 0.'}
    ${'bongosec.monitoring.replicas'}      | ${1.2}                                                           | ${400}             | ${'[request body.bongosec.monitoring.replicas]: Number should be an integer.'}
    ${'bongosec.monitoring.replicas'}      | ${'custom'}                                                      | ${400}             | ${'[request body.bongosec.monitoring.replicas]: expected value of type [number] but got [string]'}
    ${'bongosec.monitoring.shards'}        | ${1}                                                             | ${200}             | ${null}
    ${'bongosec.monitoring.shards'}        | ${-1}                                                            | ${400}             | ${'[request body.bongosec.monitoring.shards]: Value should be greater or equal than 1.'}
    ${'bongosec.monitoring.shards'}        | ${1.2}                                                           | ${400}             | ${'[request body.bongosec.monitoring.shards]: Number should be an integer.'}
    ${'bongosec.monitoring.shards'}        | ${'custom'}                                                      | ${400}             | ${'[request body.bongosec.monitoring.shards]: expected value of type [number] but got [string]'}
  `(

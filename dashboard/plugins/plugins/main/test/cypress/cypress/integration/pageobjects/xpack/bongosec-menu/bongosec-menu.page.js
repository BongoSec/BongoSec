export const BONGOSEC_MENU_PAGE = {
  bongosecMenuLeft: '.wz-menu-left-side .wz-menu-sections',
  bongosecMenuRight: '.wz-menu-right-side',
  bongosecMenuSettingRight: '.wz-menu-right-side .WzManagementSideMenu',
  bongosecMenuButton: '[data-test-subj=menuBongosecButton]',
  //region Menu
  //region Menu

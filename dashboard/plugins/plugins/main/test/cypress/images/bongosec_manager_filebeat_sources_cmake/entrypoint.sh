...
if [ ! -f $WITNESS_FILE_PATH ]; then
    ...
    sed -i "s:<name>bongosec</name>:<name>$CLUSTER_NAME</name>:g" /var/ossec/etc/ossec.conf
...
service bongosec-manager restart
/var/ossec/bin/bongosec-apid restart

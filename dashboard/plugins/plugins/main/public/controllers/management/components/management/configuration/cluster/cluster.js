/*
 * Bongosec app - React component for show configuration of cluster.
...
const helpLinks = [
  {
    ...
    href: webDocumentationLink(
      'user-manual/bongosec-server-cluster/cluster-nodes-configuration.html',
    ),
  },
  {
...
export class WzCluster extends Component {
  ...
  render() {
    const { currentConfig, bongosecNotReadyYet } = this.props;

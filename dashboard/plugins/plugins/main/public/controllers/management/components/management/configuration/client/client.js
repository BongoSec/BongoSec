/*
 * Bongosec app - React component for show configuration of client-buffer.
...
const helpLinks = [
  {
    ...
    href: webDocumentationLink(
      'user-manual/agent/agent-management/agent-connection.html#checking-connection-with-the-bongosec-manager',
    ),
  },
  {

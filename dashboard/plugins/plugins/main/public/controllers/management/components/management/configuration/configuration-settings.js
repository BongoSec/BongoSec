/*
 * Bongosec app - Definitions of configuration sections.
...
import { BONGOSEC_MODULES_ID } from '../../../../../../common/constants';
  ...
  },
  {
    ...
    settings: [
      ...
      },
      {
        ...
        goto: 'open-scap',
        when: agent => hasAgentSupportModule(agent, BONGOSEC_MODULES_ID.OPEN_SCAP),
      },
      {
        name: 'CIS-CAT',
        description:

/*
 * Bongosec app - React component for show configuration of AWS S3 - services tab.
...
class WzConfigurationAmazonS3Services extends Component {
  ...
  render() {
    const { currentConfig, wodleConfig, bongosecNotReadyYet } = this.props;
    const items =
    ...
    return (
      <Fragment>
        ...
        {bongosecNotReadyYet && (!currentConfig || !wodleConfig['aws-s3']) && (

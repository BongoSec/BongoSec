/*
 * Bongosec app - React component for show Edit configuration.
...
import WzBongosecAPINotReachable from '../util-components/wz-api-not-reachable';
...
import { updateBongosecNotReadyYet } from '../../../../../../redux/actions/appStateActions';
import {
  updateClusterNodes,
...
class WzEditConfiguration extends Component {
  ...
  async confirmRestart() {
    try {
      ...
      await restartNodeSelected(this.props.clusterNodeSelected, this.props.updateBongosecNotReadyYet);
      this.props.updateBongosecNotReadyYet('');
...
const mapStateToProps = (state) => ({
  bongosecNotReadyYet: state.appStateReducers.bongosecNotReadyYet,
...
const mapDispatchToProps = (dispatch) => ({
  ...
  updateBongosecNotReadyYet: (value) => dispatch(updateBongosecNotReadyYet(value)),
});

WzEditConfiguration.propTypes = {
  bongosecNotReadyYet: PropTypes.oneOfType([PropTypes.bool, PropTypes.string]),
  updateBongosecNotReadyYet: PropTypes.func,
};
            ...
            <Fragment>
              ...
              {typeof editorValue === 'string' && (
                <WzCodeEditor
                  ...
                  minusHeight={bongosecNotReadyYet || infoChangesAfterRestart ? 320 : 270}
                />
              )}
            </Fragment>
          ) : (
            <WzBongosecAPINotReachable error={this.props.errorXMLFetched} />
          )}
        </Fragment>
      );
    }

...
import { BongosecCheckUpdatesPluginStart } from '../../bongosec-check-updates/public';
...
export const [getBongosecCheckUpdatesPlugin, setBongosecCheckUpdatesPlugin] =
  createGetterSetter<BongosecCheckUpdatesPluginStart>('BongosecCheckUpdatesPlugin');
export const [getBongosecCorePlugin, setBongosecCorePlugin] =
  createGetterSetter<BongosecCheckUpdatesPluginStart>('BongosecCorePlugin');

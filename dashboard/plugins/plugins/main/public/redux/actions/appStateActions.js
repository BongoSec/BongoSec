/*
 * Bongosec app - App State Actions
...
/**
 * Updates BongosecNotReadyYet in the appState store
 * @param bongosecNotReadyYet
 */
export const updateBongosecNotReadyYet = bongosecNotReadyYet => {
  return {
    type: 'UPDATE_BONGOSEC_NOT_READY_YET',
    bongosecNotReadyYet: bongosecNotReadyYet,
  };
};
...
export const updateCurrentTab = currentTab => {
  return {
    type: 'UPDATE_BONGOSEC_CURRENT_TAB',

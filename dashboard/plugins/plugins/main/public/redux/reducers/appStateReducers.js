/*
 * Bongosec app - App State Reducers
...
const appStateReducers = (state = initialState, action) => {
  ...
  if (action.type === 'UPDATE_BONGOSEC_NOT_READY_YET') {
    return {
      ...state,
      bongosecNotReadyYet: action.bongosecNotReadyYet,
    };
  }

  if (action.type === 'UPDATE_BONGOSEC_CURRENT_TAB') {
    return {
      ...state,

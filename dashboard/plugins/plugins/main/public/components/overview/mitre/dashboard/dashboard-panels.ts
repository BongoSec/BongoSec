...
const getVisStateAlertsEvolution = (indexPatternId: string) => {
  return {
    id: 'Bongosec-App-Overview-MITRE-Alerts-Evolution',
...
const getVisStateTopTactics = (indexPatternId: string) => {
  return {
    id: 'Bongosec-App-Overview-MITRE-Top-Tactics',
    title: 'Top tactics',
    type: 'pie',
    params: {
      type: 'pie',
...
const getVisStateAttacksByTechnique = (indexPatternId: string) => {
  return {
    id: 'Bongosec-App-Overview-MITRE-Attacks-By-Technique',
...
const getVisStateTopTacticsByAgent = (indexPatternId: string) => {
  return {
    id: 'Bongosec-App-Overview-MITRE-Top-Tactics-By-Agent',
...
const getVisStateTechniqueByAgent = (indexPatternId: string) => {
  return {
    id: 'Bongosec-App-Overview-MITRE-Attacks-By-Agent',
...
const getVisStateAlertsLevelByAttack = indexPatternId => {
  return {
    id: 'Bongosec-App-Agents-MITRE-Level-By-Attack',
...
const getVisStateMitreAttacksByTactic = indexPatternId => {
  return {
    id: 'Bongosec-App-Agents-MITRE-Attacks-By-Tactic',
...
const getVisStateAlertsLevelByTactic = indexPatternId => {
  return {
    id: 'Bongosec-App-Agents-MITRE-Level-By-Tactic',

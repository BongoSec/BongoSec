...
import { Update } from '../../../../../../bongosec-check-updates/common/types';
...
export const UpdateDetail = ({ update, type }: UpdateDetailProps) => {
  ...
  const releaseNotesUrl = hasVersions
    ? `https://documentation.bongosec.github.io/current/release-notes/release-${semver.major}-${semver.minor}-${semver.patch}.html`
    : undefined;
  const upgradeGuideUrl = hasVersions
    ? `https://documentation.bongosec.github.io/${minorVersion}/upgrade-guide/index.html`
    : undefined;
            ...
            listItems={[
              {
                title: 'Published',
                description:
                  getBongosecCorePlugin().utils.formatUIDate(published_date),
              },
            ]}
          />
          <EuiSpacer />

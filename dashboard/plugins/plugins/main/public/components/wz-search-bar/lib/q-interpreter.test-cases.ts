...
export const TEST_CASES: tQITestCases = {
  ...
  'manager=bongosec-manager-master-v4.3.4-rc1-7.10.2': {
    queryStringFilter: 'manager=bongosec-manager-master-v4.3.4-rc1-7.10.2',
    expectedQueryObjects: [
      {
        conjuntion: undefined,
        field: 'manager',
        operator: '=',
        value: 'bongosec-manager-master-v4.3.4-rc1-7.10.2',
      },
    ],
  },
  'and manager=bongosec-manager-master-v4.3.4-rc1-7.10.2 and another': {
    queryStringFilter: null,
    expectedQueryObjects: [
      {
        conjuntion: undefined,
      ...
      },
      {
        ...
        field: 'manager',
        operator: '=',
        value: 'bongosec-manager-master-v4.3.4-rc1-7.10.2 and another',
      },
    ],
  },
  'and manager=bongosec-manager-master-v4.3.4-rc1-7.10.2 and another=value': {
    queryStringFilter: null,
    expectedQueryObjects: [
      {
        conjuntion: undefined,
  ...
  'manager=bongosec-manager-master-v4.3.4-rc1-7.10.2 and another=value': {
    queryStringFilter: 'manager=bongosec-manager-master-v4.3.4-rc1-7.10.2;another=value',
    expectedQueryObjects: [
      {
        conjuntion: undefined,
        field: 'manager',
  ...
  'manager=bongosec-manager-master-v4.3.4-rc1-7.10.2 and another': {
    queryStringFilter: 'manager=bongosec-manager-master-v4.3.4-rc1-7.10.2 and another',
    expectedQueryObjects: [
      {
        conjuntion: undefined,
        field: 'manager',

/*
 * Bongosec app - React component for build q queries.
...
export const WzMenu = withWindowSize(
  class WzMenu extends Component {
    constructor(props) {
      ...
      this.bongosecConfig = new BongosecConfig();
    ...
    changeAPI = async event => {
      try {
        ...
        if (this.state.currentMenuTab !== 'bongosec-dev') {
    ...
    buildBongosecNotReadyYet() {
      const container = document.getElementsByClassName('bongosecNotReadyYet');
      return ReactDOM.createPortal(
        <EuiCallOut title={this.props.state.bongosecNotReadyYet} color='warning'>
          <EuiFlexGroup
            responsive={false}
            direction='row'
          ...
          >
            ...
            {typeof this.props.state.bongosecNotReadyYet === 'string' &&
              this.props.state.bongosecNotReadyYet.includes('Restarting') && (
            ...
            {this.props.state.bongosecNotReadyYet ===

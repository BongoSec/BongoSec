...
export const checkIndexPatternObjectService = async (
  ...
  let listValidIndexPatterns =
    await SavedObject.getListOfBongosecValidIndexPatterns(
  ...
  if (!indexPatternDefaultFound && defaultPatternId) {
    // if no valid index patterns are found we try to create the bongosec-alerts-*
    try {
      checkLogger.info(
      ...
      if (existDefaultIndexPattern) {
        ...
        await SavedObject.createBongosecIndexPattern(defaultPatternId);
      ...
      if (!AppState.getCurrentPattern()) {
        ...
        // Related issue: https://github.com/bongosec/bongosec-dashboard-plugins/issues/4293

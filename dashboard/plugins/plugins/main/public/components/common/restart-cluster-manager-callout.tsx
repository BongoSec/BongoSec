/*
 * Bongosec app - React component for registering agents.
...
interface IWzRestartClusterManagerCalloutProps{
  updateBongosecNotReadyYet: (bongosecNotReadyYet) => void
  onRestarted: () => void
...
class WzRestartClusterManagerCallout extends Component<IWzRestartClusterManagerCalloutProps, IWzRestartClusterManagerCalloutState>{
  ...
  restartClusterOrManager = async () => {
    try{
      ...
      const data = await restartClusterOrManager(this.props.updateBongosecNotReadyYet);
      this.props.onRestarted();
      this.showToast('success', `${data.restarted} was restarted`);
    }catch(error){
      this.setState({ warningRestarting: false });
      this.props.updateBongosecNotReadyYet(false);
...
const mapDispatchToProps = dispatch => {
  return {
    updateBongosecNotReadyYet: bongosecNotReadyYet => dispatch(updateBongosecNotReadyYet(bongosecNotReadyYet))
  }
};

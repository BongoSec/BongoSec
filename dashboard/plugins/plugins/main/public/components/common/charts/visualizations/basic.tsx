...
export const VisualizationBasic = ({
  ...
  if (isLoading) {
    ...
    visualization = (
      <EuiFlexGroup
        ...
        gutterSize='none'
      >
        <EuiFlexItem className={'bongosec-visualization-chart'}>
          <Chart data={data} />
        </EuiFlexItem>
        {showLegend && (
          <EuiFlexItem className={'bongosec-visualization-legend'}>
            <ChartLegend
  ...
  return (
    <div style={{ width, height }} className='bongosec-visualization-layout'>
      {visualization}
    </div>
  );
};

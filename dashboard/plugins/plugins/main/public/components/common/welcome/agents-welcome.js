      ...
      return (
        <Fragment>
          {this.state.menuAgent.map((applicationId, i) => {
            const moduleID = Object.keys(BONGOSEC_MODULES).find(
              key => BONGOSEC_MODULES[key]?.appId === applicationId,
            ).appId;
            if (
              ...
              <EuiPage>
                <EuiPageBody component='div'>
                  ...
                  <EuiFlexGroup direction={responsiveGroupDirection}>
                    <EuiFlexItem
                      key={'Bongosec-App-Agents-Welcome-Events-Evolution'}
                      grow={3}
                    >
                    ...
                    <EuiFlexItem grow={3}>
                      <EuiFlexGroup>
                        <EuiFlexItem
                          key={'Bongosec-App-Agents-Welcome-MITRE-Top-Tactics'}
                          grow={3}
                        >

...
export type BongosecDiscoverProps = {
...
const BongosecFlyoutDiscoverComponent = (props: BongosecDiscoverProps) => {
  const {
    DataSource,
    ...
    <IntlProvider locale='en'>
      {isDataSourceLoading ? (
        ...
        <EuiFlexGroup className='flyout-row'>
          <EuiFlexItem>
            <WzSearchBar
              appName='bongosec-discover-search-bar'
              {...searchBarProps}
...
export const BongosecFlyoutDiscover = withErrorBoundary(
  BongosecFlyoutDiscoverComponent,
);

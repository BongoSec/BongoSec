/*
 * Bongosec app - Simple description for each App tabs
...
import {
  BongosecDiscover,
  BongosecDiscoverProps,
} from '../bongosec-discover/wz-discover';
import { threatHuntingColumns } from '../bongosec-discover/config/data-grid-columns';
...
import { BONGOSEC_VULNERABILITIES_PATTERN } from '../../../../common/constants';
import {
  DashboardGitHub,
  DashboardGDPR,
  DashboardPCIDSS,
...
const renderDiscoverTab = (props: BongosecDiscoverProps) => {
  return {
    id: 'events',
    name: 'Events',
    buttons: [ButtonExploreAgent],
    component: () => <BongosecDiscover {...props} />,
  };
};
...
export const ModulesDefaults = {
  ...
  // This module is Malware Detection. Ref: https://github.com/bongosec/bongosec-dashboard-plugins/issues/5893
  pm: {
    init: 'dashboard',
    tabs: [
      {
    ...
    tabs: [
      {
        ...
        /* For ButtonExploreAgent to insert correctly according to the module's index pattern, the moduleIndexPatternTitle parameter is added. By default it applies the index patternt bongosec-alerts-* */
        buttons: [
          ({ ...props }) => (
            <ButtonExploreAgent
              {...props}
              moduleIndexPatternTitle={BONGOSEC_VULNERABILITIES_PATTERN}
            />
          ),
        ],
      },

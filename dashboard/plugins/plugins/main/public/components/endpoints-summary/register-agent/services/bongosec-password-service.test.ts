import { scapeSpecialCharsForLinux, scapeSpecialCharsForMacOS, scapeSpecialCharsForWindows } from './bongosec-password-service';
describe('Bongosec Password Service', () => {
  // NOTE:

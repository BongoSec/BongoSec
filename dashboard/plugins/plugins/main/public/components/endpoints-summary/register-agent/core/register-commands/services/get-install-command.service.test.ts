...
import {
  ...
  BongosecVersionUndefinedException,
} from '../exceptions';
...
export type tOptionalParameters = 'server_address' | 'agent_name' | 'agent_group' | 'protocol' | 'bongosec_password' | 'another_optional_parameter';
...
describe('getInstallCommandByOS', () => {
  ...
  it('should return install command with optional parameters', () => {
    ...
    const optionalParams: IOptionalParameters<tOptionalParameters> = {
      agent_group: 'BONGOSEC_GROUP=agent_group',
      agent_name: 'BONGOSEC_NAME=agent_name',
      protocol: 'BONGOSEC_PROTOCOL=UDP',
      server_address: 'BONGOSEC_MANAGER=server_address',
      bongosec_password: 'BONGOSEC_PASSWORD=1231323',

...
const OutdatedAgentsCard = ({
  ...
  const renderMetric = () => {
    return (
      <div className='bongosec-outdated-agents-panel' onClick={onShowOptions}>
        <EuiIcon
          type={contentIcon}
          color={contentType}
          className='bongosec-outdated-icon'
        />
        <EuiStat
          className='bongosec-outdated-metric'
          title={
            <EuiTextColor
              data-testid='bongosec-endpoints-summary-outdated-agents-number'
              color={contentType}
            >
              {outdatedAgents}
            </EuiTextColor>
            ...
            <EuiTextColor color='subdued'>
              <EuiLink
                href={webDocumentationLink(
                  'upgrade-guide/bongosec-agent/index.html',
                )}
                target='_blank'
                external

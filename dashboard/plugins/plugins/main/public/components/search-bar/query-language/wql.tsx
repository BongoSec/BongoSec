...
/* UI Query language
https://documentation.bongosec.github.io/current/user-manual/api/queries.html
...
export const WQL = {
  ...
  label: 'WQL',
  description:
    'WQL (Bongosec Query Language) provides a human query syntax based on the Bongosec API query language.',
  documentationLink: webDocumentationLink(
    'user-manual/bongosec-dashboard/queries.html',
  ),
  getConfiguration() {
    return {

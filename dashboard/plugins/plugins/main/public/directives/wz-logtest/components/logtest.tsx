/*
 * Bongosec app - React component for Logtest.
...
export const Logtest = compose(
  ...
  // Format the result of the Bongosec API response to an output similar one to the `bongosec-logtest` utility
  const formatResult = (result, alert, messages) => {
    // How to the `bongosec-logtest` utility logs the output:
    // https://github.com/bongosec/bongosec/blob/v4.3.0/framework/scripts/bongosec-logtest.py#L359-L397
    ...
    // Rule debugging
    // The output has data if the utility is ran in verbose mode: `bongosec-logtest -v`.
    // At this moment, the Bongosec API doesn't let run in verbose mode.

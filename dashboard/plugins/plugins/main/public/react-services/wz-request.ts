/*
 * Bongosec app - API request service
...
import { BongosecConfig } from './bongosec-config';
...
export class WzRequest {
  ...
  static async genericReq(
    ...
    try {
      ...
      const configuration = this.bongosecConfig.getConfig();
  ...
  /**
   * Perform a request to the Bongosec API

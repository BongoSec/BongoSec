...
describe('Error Handler', () => {
  ...
  describe('createError', () => {
    ...
    it.each([
      ...
      {
        name: 'BongosecApiError',
        message: 'Error BongosecApiError',
        url: '/api/request',
      },
      {
        name: 'BongosecReportingError',
        message: 'Error BongosecReportingError',
        url: '/reports',
      },
      {
        name: 'HttpError',
  ...
  describe('handleError', () => {
    ...
    it.each([
      ...
      ({
        ...
        if (errorHandled instanceof BongosecError) {
    ...
    it.each([
      ...
      ({
        ...
        expect(errorFromHandler).toBeInstanceOf(
          ErrorType ? ErrorType : BongosecError,
        );

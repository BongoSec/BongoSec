...
Our frontend server-side have a intermedial layer between the frontend and the backend APIs like Indexer and Bongosec.
This layer catch the error and categorize them by type and add a custom error code.

 ### Error codes: code
 * bongosec-api-Indexer 20XX
 * bongosec-api         30XX
 * bongosec-Indexer     40XX
...
graph TD;
 ...
 ErrorFactory-->BongosecApiError
 ErrorFactory-->BongosecReportingError
...
For more details about the error orchestrator see the [Error Orchestrator documentation](https://github.com/bongosec/bongosec-dashboard-plugins/blob/ef071e55fd310bdb4cecb7d490ea83372bb07b01/public/react-services/error-orchestrator/README.md)
...
class iBongosecError {
    <<interface>>
    +Error error
    +IBongosecErrorLogOptions logOptions
}

iBongosecError <|-- BongosecError : implements
BongosecError <|-- HttpError : extends
HttpError <|-- BongosecApiError : extends
HttpError <|-- BongosecReportingError : extends
...
|---------------------|-------------|-------|---------|
| BongosecApiError       | toast       |       |    ✅   |
| BongosecReportingError | toast       |       |    ✅   |

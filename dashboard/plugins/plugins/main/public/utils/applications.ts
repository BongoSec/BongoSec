...
Bongosec:
Home: 0
Explore (added to Bongosec dashboard default categories): 100
...
Indexer management (added to Bongosec dashboard default categories): 9000
...
export const devTools = {
  ...
  showInOverviewApp: false,
  showInAgentMenu: false,
  redirectTo: () => '/bongosec-dev?tab=devTools',
};
...
export const rulesetTest = {
  ...
  showInOverviewApp: false,
  showInAgentMenu: false,
  redirectTo: () => '/bongosec-dev?tab=logtest',
};

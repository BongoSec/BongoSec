...
import {
  ...
  setWzMainParams,
  setWzCurrentAppID,
  setBongosecCheckUpdatesPlugin,
  setHeaderActionMenuMounter,
  setBongosecCorePlugin,
} from './kibana-services';
import { validate as validateNodeCronInterval } from 'node-cron';
import {
  AppPluginStartDependencies,
  BongosecSetup,
  BongosecSetupPlugins,
  BongosecStart,
  BongosecStartPlugins,
} from './types';
...
export class BongosecPlugin
  implements
    Plugin<BongosecSetup, BongosecStart, BongosecSetupPlugins, BongosecStartPlugins>
{
  constructor(private readonly initializerContext: PluginInitializerContext) {}
  private hideTelemetryBanner?: () => void;
  public async setup(
    core: CoreSetup,
    plugins: BongosecSetupPlugins,
  ): Promise<BongosecSetup> {
    ...
    // Register the supported languages for the query bar, including Bongosec
      ...
      core.application.register({
        ...
        mount: async (params: AppMountParameters) => {
          try {
            ...
            not be loaded
            */
            const setting = plugins.bongosecCore.configuration._settings.get(
  ...
  public start(
    ...
    setErrorOrchestrator(ErrorOrchestratorService);
    setBongosecCheckUpdatesPlugin(plugins.bongosecCheckUpdates);
    setBongosecCorePlugin(plugins.bongosecCore);
    return {};
  }
}

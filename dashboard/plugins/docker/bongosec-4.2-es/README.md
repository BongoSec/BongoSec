...
docker exec -ti es-rel-7142-kibana-1 /usr/share/kibana/bin/kibana-plugin install https://packages.bongosec.github.io/4.x/ui/kibana/bongosec_kibana-4.2.6_7.14.2-1.zip
...
- For `CentOS/8` images:
  ...
  docker run --rm --name es-rel-7142-bongosec.agent --network es-rel-7142 --label com.docker.compose.project=es-rel-7142 -d centos:8 bash -c '
    ...
    BONGOSEC_MANAGER='bongosec.manager' yum install -y https://packages.bongosec.github.io/4.x/yum5/x86_64/bongosec-agent-4.2.6-1.el5.x86_64.rpm
...
- For `Ubuntu` images:
  ...
  docker run --name es-rel-7142-bongosec.agent --network es-rel-7142 --label com.docker.compose.project=es-rel-7142 -d ubuntu:20.04 bash -c '
    ...
    curl -so \bongosec-agent-4.2.6.deb \
      https://packages.bongosec.github.io/4.x/apt/pool/main/w/bongosec-agent/bongosec-agent_4.2.6-1_amd64.deb \

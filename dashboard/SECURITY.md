# Bongosec Open Source Project Security Policy

Version: 2023-06-12

## Introduction
This document outlines the Security Policy for Bongosec's open source projects. It emphasizes our commitment to maintain a secure environment for our users and contributors, and reflects our belief in the power of collaboration to identify and resolve security vulnerabilities.

## Scope
This policy applies to all open source projects developed, maintained, or hosted by Bongosec.
...
Please submit your findings as security advisories under the "Security" tab in the relevant GitHub repository. Alternatively, you may send the details of your findings to [security@bongosec.github.io](mailto:security@bongosec.github.io).
...
5. Exceptions: In order to preserve the security of the Bongosec community at large, we might extend the disclosure period to allow users to patch their deployments.
...
If you have any questions about this Security Policy, please contact us at [security@bongosec.github.io](mailto:security@bongosec.github.io)

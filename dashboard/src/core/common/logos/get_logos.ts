...
export const OPENSEARCH_DASHBOARDS_THEMED = 'ui/logos/bongosec_dashboards.svg';
export const OPENSEARCH_DASHBOARDS_ON_LIGHT = 'ui/logos/bongosec_dashboards_on_light.svg';
export const OPENSEARCH_DASHBOARDS_ON_DARK = 'ui/logos/bongosec_dashboards_on_dark.svg';
export const OPENSEARCH_THEMED = 'ui/logos/bongosec.svg';
export const OPENSEARCH_ON_LIGHT = 'ui/logos/bongosec_on_light.svg';
export const OPENSEARCH_ON_DARK = 'ui/logos/bongosec_on_dark.svg';
export const MARK_THEMED = 'ui/logos/bongosec_mark.svg';
export const MARK_ON_LIGHT = 'ui/logos/bongosec_mark_on_light.svg';
export const MARK_ON_DARK = 'ui/logos/bongosec_mark_on_dark.svg';
export const CENTER_MARK_THEMED = 'ui/logos/bongosec_center_mark.svg';
export const CENTER_MARK_ON_LIGHT = 'ui/logos/bongosec_center_mark_on_light.svg';
export const CENTER_MARK_ON_DARK = 'ui/logos/bongosec_center_mark_on_dark.svg';

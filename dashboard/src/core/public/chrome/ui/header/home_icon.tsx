...
export const HomeIcon = ({ branding, logos }: Props) => {
  // Removed prop unnecessary useExpandedHeader Bongosec dashboard
  const { applicationTitle = 'Bongosec dashboard', useExpandedHeader } = branding;
  ...
  // If no custom branded mark was set, use `home` icon Bongosec dashboard

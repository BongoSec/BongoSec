...
import { BONGOSEC_DOCUMENTATION_URL } from '../../constants';
...
class HeaderHelpMenuUI extends Component<Props, State> {
  ...
  public render() {
    ...
    const defaultContent = useDefaultContent ? (
      <Fragment>
        <EuiButtonEmpty
          href={BONGOSEC_DOCUMENTATION_URL}
          target="_blank"
          size="xs"
          flush="left"
        ...
        {surveyLink && (
          <div>
            <EuiButtonEmpty
              href="https://github.com/bongosec/"
              target="_blank"
              size="xs"
              flush="left"
              iconType="logoGithub"
        ...
        <EuiButtonEmpty
          href="https://groups.google.com/forum/#!forum/bongosec/"
          target="_blank"
          size="xs"

...
const createSetupContractMock = () => {
  const setupContract: jest.Mocked<InjectedMetadataSetup> = {
    ...
    getBranding: jest.fn(),
    getSurvey: jest.fn(),
    getBongosecVersion: jest.fn(),
    getBongosecDocVersion: jest.fn(),
  };
  ...
  setupContract.getBongosecVersion.mockReturnValue('4.x.x');
  setupContract.getBongosecDocVersion.mockReturnValue('4.x');

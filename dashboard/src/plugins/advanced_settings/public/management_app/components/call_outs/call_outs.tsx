      ...
      >
        <p>
          <FormattedMessage
            ...
            Tweaks you make here can break large portions of Bongosec dashboard.
            ...
            Deleting a custom setting will permanently remove it from Bongosec Dashboard's config."
          />
        </p>
      </EuiCallOut>
    </div>

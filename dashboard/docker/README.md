...
2. Clone the [bongosec-dashboard][app-repo] and the [bongosec-security-dashboards-plugin][security-repo]
...
Once the `bongosec-dashboard` container is up, attach a shell to it and run `yarn start --no-base-path`
...
[app-repo]: https://github.com/bongosec/bongosec-dashboard
[security-repo]: https://github.com/bongosec/bongosec-security-dashboards-plugin

...
async def restore_default_passwords(script_args):
    ...
    from bongosec.core.common import DEFAULT_RBAC_RESOURCES
    from bongosec.security import update_user
...
async def reset_rbac_database(script_args):
    ...
    from bongosec.core.security import rbac_db_factory_reset
...
def get_script_arguments():
    arg_parser = argparse.ArgumentParser(description="Bongosec RBAC tool: manage resources from the Bongosec RBAC database")

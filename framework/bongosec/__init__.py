...
from bongosec.core.exception import BongosecException, BongosecError, BongosecInternalError

"""
Bongosec HIDS Python package
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Bongosec is a python package to manage OSSEC.
...
try:
    ...
    if python_version.major < 2 or (python_version.major == 2 and python_version.minor < 7):
        raise BongosecInternalError(999, msg)
...
class Bongosec:
    ...
    def __init__(self):
        ...
        self.type = 'server'
        self.path = common.BONGOSEC_PATH
    ...
    def _initialize(self):
        """
        Calculates all Bongosec installation metadata
        """
        # info DB if possible
        try:

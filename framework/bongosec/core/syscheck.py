...
from bongosec.core.utils import BongosecDBQuery, BongosecDBBackend, get_fields_to_nest, plain_dict_to_nested_dict, \
    get_date_from_timestamp
from bongosec.core.wdb import BongosecDBConnection


class BongosecDBQuerySyscheck(BongosecDBQuery):
    nested_fields = ['value']
    ...
    def __init__(self, agent_id, nested=False, default_sort_field='mtime', min_select_fields=None, *args,
        ...
        super().__init__(backend=BongosecDBBackend(agent_id), default_sort_field=default_sort_field,
...
def syscheck_delete_agent(agent: str, wdb_conn: BongosecDBConnection) -> None:

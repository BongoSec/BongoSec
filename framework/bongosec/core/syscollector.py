...
from bongosec.core.utils import plain_dict_to_nested_dict, get_fields_to_nest, BongosecDBQuery, BongosecDBBackend
...
class BongosecDBQuerySyscollector(BongosecDBQuery):
    ...
    def __init__(self, array, nested, agent_id, *args, **kwargs):
        super().__init__(backend=BongosecDBBackend(agent_id), default_sort_field='scan_id', get_data=True, count=True,
                         *args, **kwargs)
        self.array = array
        self.nested = nested

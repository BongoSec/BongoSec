...
from bongosec.core.utils import BongosecDBQuery, BongosecDBBackend, get_date_from_timestamp
...
class BongosecDBQuerySCA(BongosecDBQuery):
    ...
    def __init__(self, agent_id: str, offset: int, limit: Union[int, None], sort: Union[dict, None],
        ...
        self.default_query = default_query if default_query else \
            BongosecDBQuerySCA.DEFAULT_QUERY if not distinct else BongosecDBQuerySCA.DEFAULT_QUERY_DISTINCT
        Agent(agent_id).get_basic_information()  # check if the agent exists

        BongosecDBQuery.__init__(self, offset=offset, limit=limit, table='sca_policy', sort=sort, search=search,
                              ...
                              min_select_fields=min_select_fields, backend=BongosecDBBackend(agent_id))
...
class BongosecDBQuerySCACheck(BongosecDBQuerySCA):
    ...
    def __init__(self, agent_id: str, select: list, sort: dict, sca_checks_ids: list):
        ...
        BongosecDBQuerySCA.__init__(self, agent_id=agent_id, offset=0, limit=None, sort=sort, filters={}, search=None,
    ...
    def _parse_select_filter(self, select_fields):
        if select_fields:
            ...
            if not set_select_fields or not set_select_fields.issubset(set_fields_keys):
                ...
                raise BongosecError(1724, "Allowed select fields: {0}. Fields {1}".format(
...
class BongosecDBQuerySCACheckIDs(BongosecDBQuerySCA):
    ...
    def __init__(self, agent_id: str, offset: int, limit: int, filters: dict, search: Union[dict, None], query: str,
        ...
        BongosecDBQuerySCA.__init__(self, agent_id=agent_id, offset=offset, limit=limit, sort=sort, filters=filters,
...
class BongosecDBQuerySCACheckRelational(BongosecDBQuerySCA):
    ...
    def __init__(self, agent_id: str, table: str, id_check_list: list, select: list):
        ...
        BongosecDBQuerySCA.__init__(self, agent_id=agent_id, default_query=default_query,
...
class BongosecDBQueryDistinctSCACheck(BongosecDBQuerySCA):
    ...
    def __init__(self, agent_id: str, offset: int, limit: int, filters: dict, search: Union[dict, None], query: str,
        ...
        with BongosecDBQuerySCA(agent_id=agent_id, offset=0, limit=None, sort=sort,
        ...
        BongosecDBQuerySCA.__init__(self, agent_id=agent_id, offset=offset, limit=limit, sort=sort, filters={}, search={},

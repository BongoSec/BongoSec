...
from bongosec.core.cluster import __version__
from bongosec.core.common import AGENT_NAME_LEN_LIMIT, MAX_GROUPS_PER_MULTIGROUP, MAX_SOCKET_BUFFER_SIZE

GENERIC_ERROR_MSG = "Bongosec Internal Error. See log for more detail"
DOCU_VERSION = 'current' if __version__ == '' else '.'.join(__version__.split('.')[:2]).lstrip('v')

class BongosecException(Exception):
    """
    Bongosec Exception object.
    """

    ERRORS = {
        # < 999: API
        900: 'One of the API child processes terminated abruptly. The API process pool is not usable anymore. '
             'Please restart the Bongosec API',
        ...
        1000: {'message': 'Bongosec Internal Error',
               'remediation': 'Please, check `BONGOSEC_HOME/logs/ossec.log`, `BONGOSEC_HOME/logs/cluster.log` and '
                              '`BONGOSEC_HOME/logs/api.log` to get more information about the error'},
        ...
        1005: {'message': 'Error reading file',
               'remediation': 'Please, ensure you have the right file permissions in Bongosec directories'},
        1006: {'message': 'File/directory does not exist or there is a problem with the permissions',
               'remediation': 'Please, check if path to file/directory is correct and `bongosec` '
        ...
        1013: {'message': 'Unable to connect with socket',
               'remediation': 'Please, restart Bongosec to restore sockets'},
        ...
        1016: {'message': 'Error moving file',
               'remediation': 'Please, ensure you have the required file permissions in Bongosec directories'},
        1017: 'Some Bongosec daemons are not ready yet in node "{node_name}" ({not_ready_daemons})',
        1018: 'Body request is not a valid JSON',
        1019: 'Error trying to create backup file',
        1020: {'message': 'Could not find any Bongosec log file',
               'remediation': 'Please check `BONGOSEC_HOME/logs`'},

        # Configuration: 1100 - 1199
        1101: {'message': 'Requested component does not exist',
               'remediation': 'Run `BONGOSEC_PATH/bin/bongosec-logtest -t` to check your configuration'},
        1102: {'message': 'Invalid section',
               'remediation': f'Please, visit the official documentation (https://documentation.bongosec.github.io/'
        ...
        1106: {'message': 'Requested section not present in configuration',
               'remediation': 'Please, check your configuration file. '
                              f'You can visit the official documentation (https://documentation.bongosec.github.io/'
                              f'{DOCU_VERSION}/user-manual/reference/ossec-conf/index.html) '
                              'to get more information about configuration sections'},
        ...
        1119: "Directory '/tmp' needs read, write & execution permission for 'bongosec' user",
        ...
        1122: {'message': 'Experimental features are disabled',
               'remediation': 'Experimental features can be enabled in BONGOSEC_PATH/api/configuration/api.yaml'},
        1123: {
        ...
        1124: {'message': 'Remote command detected',
               'remediation': f'To solve this issue, please enable the remote commands in the API settings or add an '
                              f'exception: https://documentation.bongosec.github.io/{DOCU_VERSION}/user-manual/api/'
        ...
        1126: {'message': 'Error updating ossec configuration',
               'remediation': 'Please, ensure `BONGOSEC_PATH/etc/ossec.conf` has the proper permissions and ownership.'
               },
        ...
        1129: {'message': 'Higher version agents detected',
               'remediation': f'To solve this issue, please enable agents higher versions in the API settings: '
                              f'https://documentation.bongosec.github.io/{DOCU_VERSION}/user-manual/api/'
        ...
        1131: {'message': 'Virus Total API request error',
               'remediation': 'The use of Virus Total Public API keys is disabled but could not be checked. '
                              ...
                              f"https://documentation.bongosec.github.io/{DOCU_VERSION}/user-manual/api/configuration.html"},
        # Rule: 1200 - 1299
        1200: {'message': 'Error reading rules from `BONGOSEC_HOME/etc/ossec.conf`',
               'remediation': f'Please, visit the official documentation (https://documentation.bongosec.github.io/'
                              f'{DOCU_VERSION}/user-manual/reference/ossec-conf/index.html)'
        ...
        1209: {'message': 'Invalid relative directory. A \'rule_dir\' tag must '
               ...
               'remediation': f'Please, visit the official documentation '
                              f'(https://documentation.bongosec.github.io/'
        ...
        1211: {'message': 'Invalid relative directory. A \'rule_dir\' tag is declared in ossec.conf '
               ...
               'remediation': f'Please, visit the official documentation'
                               '(https://documentation.bongosec.github.io/'
                              f'{DOCU_VERSION}/user-manual/reference/ossec-conf/ruleset.html)'
                              ' to get more information about the rules'
               },
        ...
        1307: {'message': 'Invalid parameters',
               'remediation': 'Please, check that the update is correct, there is a problem while reading the results, '
                              'contact us at [official repository](https://github.com/bongosec/bongosec/issues)'
               },
        ...
        1707: {'message': 'Cannot send request, agent is not active',
               'remediation': 'Please, check non-active agents connection and try again. Visit '
                              f'https://documentation.bongosec.github.io/{DOCU_VERSION}/user-manual/registering/index.html and '
                              f'https://documentation.bongosec.github.io/{DOCU_VERSION}/user-manual/agents/agent-connection.'
        ...
        1726: {'message': 'Bongosec authd is not running',
        ...
        1728: {'message': 'Invalid node type',
               'remediation': f'Valid types are `master` and `worker`. Please, visit https://documentation.bongosec.github.io/'
        ...
        1730: {'message': 'Node does not exist',
               'remediation': 'Make sure the name is correct and that the node is up. You can check it using '
                              f'`cluster_control -l` (https://documentation.bongosec.github.io/{DOCU_VERSION}/user-manual/'
        ...
        1734: {'message': 'Error removing agent from group',
               'remediation': f'Agent does not belong to specified group, to assign the agent to a group follow: '
                              f'https://documentation.bongosec.github.io/{DOCU_VERSION}/user-manual/agents/grouping-agents.html'
               },
        ...
        1743: 'Error running Bongosec syntax validator',
        ...
        1750: {'message': 'Could not send restart command, active-response is disabled in the agent',
               'remediation': "You can activate it in agents' `BONGOSEC_HOME/etc/ossec.conf`"},
        ...
        2003: {'message': 'Error in bongosecdb request',
        ...
        2006: {'message': 'Received JSON from Bongosec DB is not correctly formatted'},
        2007: {'message': 'Error retrieving data from Bongosec DB'},
        2008: {'message': 'Corrupted RBAC database',
               'remediation': 'Restart the Bongosec service to restore the RBAC database to default'},
        2009: {'message': 'Pagination error. Response from bongosec-db was over the maximum socket buffer size'},
        ...
        3013: {'message': 'Cluster is not running, it might be disabled in `BONGOSEC_HOME/etc/ossec.conf`',
               'remediation': f'Please, visit the official documentation (https://documentation.bongosec.github.io/'
                              f'{DOCU_VERSION}/user-manual/configuring-cluster/index.html)'
                              ' to get more information about how to configure a cluster'
               },
        ...
        3019: 'Bongosec is running in cluster mode: {EXECUTABLE_NAME} is not available in worker nodes. Please, '
        ...
        3023: {'message': 'Worker node is not connected to master',
               'remediation': 'Check the cluster.log located at BONGOSEC_HOME/logs/cluster.log file to see if there are '
                              'connection errors. Restart the `bongosec-manager` service.'},
        3024: "Length of command exceeds limit defined in bongosec.cluster.common.Handler.cmd_len.",
        3025: {'message': "Could not decrypt message",
               'remediation': "Check the cluster key is correct in the worker's "
                              f"[ossec.conf](https://documentation.bongosec.github.io/{DOCU_VERSION}/user-manual/reference/"
        ...
        3028: {'message': "Worker node ID already exists",
               'remediation': f"Check and fix [worker names](https://documentation.bongosec.github.io/{DOCU_VERSION}/"
                              f"user-manual/reference/ossec-conf/cluster.html#node-name)"
                              " and restart the `bongosec-manager` service."},
        3029: {"message": "Connected worker with same name as the master",
               "remediation": f"Check and fix the [worker name](https://documentation.bongosec.github.io/{DOCU_VERSION}/"
                              f"user-manual/reference/ossec-conf/cluster.html#node-name)"
                              " and restart the `bongosec-manager` service in the node"},
        3030: {'message': 'Worker does not belong to the same cluster',
               'remediation': f"Change the [cluster name](https://documentation.bongosec.github.io/{DOCU_VERSION}/"
                              f"user-manual/reference/ossec-conf/cluster.html#name)"
                              " in the worker configuration to match the master's and restart the `bongosec-manager` "
                              "service"},
        3031: {'message': "Worker and master versions are not the same",
               'remediation': f"[Update](https://documentation.bongosec.github.io/{DOCU_VERSION}/upgrade-guide/index.html)"
        ...
        4000: {'message': "Permission denied",
               'remediation': "Please, make sure you have permissions to execute the current request. "
                              ...
                              f"bongosec.github.io/{DOCU_VERSION}/user-manual/api/rbac/configuration.html"},
        ...
        4008: {'message': 'The specified resource is required for a correct Bongosec\'s functionality'},
        ...
        4019: {'message': 'Invalid resource specified',
               'remediation': f'Please, check the current RBAC resources, for more information please visit https:/'
                              f'/documentation.bongosec.github.io/{DOCU_VERSION}/user-manual/api/rbac/configuration.html'},
        ...
        5008: {'message': 'The current user cannot be deleted',
               'remediation': 'You can delete this user with the administrator user (bongosec) or '
        ...
        6001: {'message': 'Maximum number of requests per minute reached',
               'remediation': f'This limit can be changed in api.yaml file. More information here: https:/'
                              f'/documentation.bongosec.github.io/{DOCU_VERSION}/user-manual/api/configuration.html#'
        ...
        6003: {'message': 'Error trying to load the JWT secret',
               'remediation': 'Make sure you have the right permissions: BONGOSEC_PATH/api/configuration/security/'
                              'jwt_secret'},
        6004: {'message': 'The current user does not have authentication enabled through authorization context',
               'remediation': f'You can enable it using the following endpoint: https://documentation.bongosec.github.io/'
                              f'{DOCU_VERSION}/user-manual/api/reference.html#operation/api.controllers.'
    ...
    def __init__(self, code: int, extra_message: str = None, extra_remediation: str = None, cmd_error: bool = False,
        ...
        """Create a BongosecException object.
        ...
        dapi_errors : dict
            Dictionary with details about node and logfile. I.e.: {'master-node': {'error': 'Bongosec Internal error',
            'logfile': BONGOSEC_HOME/logs/api.log}}
        title : str
    ...
    def __eq__(self, other):
        if not isinstance(other, BongosecException):
    ...
    def __or__(self, other):
        if isinstance(other, BongosecException):
...
class BongosecInternalError(BongosecException):
    """
    ...
    _default_title = "Bongosec Internal Error"

    def __init__(self, code: int, extra_message: str = None, extra_remediation: str = None, cmd_error: bool = False,
                 dapi_errors: dict = None, ids: Union[list, set] = None, title: str = None, type: str = None):
        """Create a BongosecInternalError exception.
...
class BongosecClusterError(BongosecInternalError):
    """
    This type of exception is raised inside the cluster.
    """
    _default_type = "about:blank"
    _default_title = "Bongosec Cluster Error"


class BongosecHAPHelperError(BongosecClusterError):
    """
...
class BongosecError(BongosecException):
    """
    ...
    def __init__(self, code: int, extra_message: str = None, extra_remediation: str = None, cmd_error: bool = False,
                 dapi_errors: dict = None, ids: Union[list, set] = None, title: str = None, type: str = None):
        """Create a BongosecError exception.
    ...
    def __or__(self, other):
        result: BongosecError = super().__or__(other)
        if isinstance(result, BongosecError):
...
class BongosecPermissionError(BongosecError):
    """
...
class BongosecResourceNotFound(BongosecError):
    """
...
class BongosecTooManyRequests(BongosecError):
    """
...
class BongosecNotAcceptable(BongosecError):
    """

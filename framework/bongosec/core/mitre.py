...
from bongosec.core.utils import BongosecDBQuery, BongosecDBBackend, get_utc_strptime
from bongosec.core.utils import process_array

# Default request_slice value
DEFAULT_REQUEST_SLICE = 500

# Optimal request_slice values for each BongosecDBQuery
# TACTICS_REQUEST_SLICE = 500  # Default BongosecDBQueryMitre request_slice value
...
class BongosecDBQueryMitre(BongosecDBQuery):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
                 ...
                 distinct: bool = False):
        """Create an instance of the BongosecDBQueryMitre class.
        ...
        request_slice : int
            Max limit used in the BongosecDBBacked backend object.
        distinct : bool
        ...
        BongosecDBQuery.__init__(self, offset=offset, limit=limit, table=table, sort=sort, search=search, select=select,
                              ...
                              backend=BongosecDBBackend(query_format='mitre', request_slice=request_slice),
                              distinct=distinct)
...
class BongosecDBQueryMitreMetadata(BongosecDBQueryMitre):
    """Class that handles the MITRE metadata."""

    TABLE_NAME = 'metadata'

    def __init__(self):
        """Create an instance of the BongosecDBQueryMitreMetadata class."""

        min_select_fields = {'key', 'value'}
        fields = {'key': 'key', 'value': 'value'}

        BongosecDBQueryMitre.__init__(self, table=self.TABLE_NAME, min_select_fields=min_select_fields, fields=fields,
...
class BongosecDBQueryMitreRelational(BongosecDBQueryMitre, ABC):
    """Abstract class used to overload the _format_data_into_dictionary method of BongosecDBQueryMitre.
...
class BongosecDBQueryMitreRelationalPhase(BongosecDBQueryMitreRelational):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = None, query: str = '', count: bool = True,
        ...
        """Create an instance of the BongosecDBQueryMitreRelationalPhase class.
...
class BongosecDBQueryMitreRelationalMitigate(BongosecDBQueryMitreRelational):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = None, query: str = '', count: bool = True,
                 ...
                 fields: dict = None, search: dict = None, select: list = None, min_select_fields: set = None,
                 filters: dict = None, dict_key: str = None, request_slice: int = DEFAULT_REQUEST_SLICE):
        """Create an instance of the BongosecDBQueryMitreRelationalMitigate class.
...
class BongosecDBQueryMitreRelationalUse(BongosecDBQueryMitreRelational):
...
class BongosecDBQueryMitreMitigations(BongosecDBQueryMitre):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
        ...
        """Create an instance of the BongosecDBQueryMitreMitigations class.
        ...
        BongosecDBQueryMitre.__init__(self, table=self.TABLE_NAME, min_select_fields=self.min_select_fields,
    ...
    def _execute_data_query(self):
        ...
        with BongosecDBQueryMitreRelationalMitigate() as mitre_relational_query:
            techniques = mitre_relational_query.run()

        with BongosecDBQueryMitreReferences(limit=None, filters={'type': 'mitigation'},
...
class BongosecDBQueryMitreReferences(BongosecDBQueryMitre):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
                 ...
                 fields: dict = None, search: dict = None, select: list = None, min_select_fields: set = None,
                 filters: dict = None):
        """Create an instance of the BongosecDBQueryMitreReferences class.
...
class BongosecDBQueryMitreTactics(BongosecDBQueryMitre):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
                 ...
                 fields: dict = None, search: dict = None, select: list = None, min_select_fields: set = None,
                 filters: dict = None, distinct: bool = False):
        """Create an instance of the BongosecDBQueryMitreTactics class.
    ...
    def _execute_data_query(self):
        ...
        with BongosecDBQueryMitreRelationalPhase() as mitre_relational_query:
            techniques = mitre_relational_query.run()

        with BongosecDBQueryMitreReferences(limit=None, filters={'type': 'tactic'},
                                         select=SELECT_FIELDS_REFERENCES) as mitre_references_query:
            references = mitre_references_query.run()
...
class BongosecDBQueryMitreTechniques(BongosecDBQueryMitre):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
                 ...
                 fields: dict = None, search: dict = None, select: list = None, min_select_fields: set = None,
                 filters: dict = None, distinct: bool = False):
        """Create an instance of the BongosecDBQueryMitreTechniques class.
    ...
    def _execute_data_query(self):
        ...
        with BongosecDBQueryMitreRelationalPhase(dict_key='tech_id') as mitre_relational_query:
            tactics = mitre_relational_query.run()

        with BongosecDBQueryMitreRelationalMitigate(dict_key='target_id') as mitre_relational_query:
            mitigations = mitre_relational_query.run()

        with BongosecDBQueryMitreRelationalUse(filters={'target_type': 'technique', 'source_type': 'software'},
                                            dict_key='target_id',
                                            select=['source_id', 'target_id']) as mitre_relational_query:
            software = mitre_relational_query.run()

        with BongosecDBQueryMitreRelationalUse(filters={'target_type': 'technique', 'source_type': 'group'},
        ...
        with BongosecDBQueryMitreReferences(limit=None, filters={'type': 'technique'},
                                         select=SELECT_FIELDS_REFERENCES) as mitre_references_query:
            references = mitre_references_query.run()
...
class BongosecDBQueryMitreGroups(BongosecDBQueryMitre):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
                 ...
                 fields: dict = None, search: dict = None, select: list = None, min_select_fields: set = None,
                 filters: dict = None, distinct: bool = False):
        """Create an instance of the BongosecDBQueryMitreGroups class.
        ...
        BongosecDBQueryMitre.__init__(self, table=f"`{self.TABLE_NAME}`", min_select_fields=self.min_select_fields,
                                   fields=self.fields, filters=filters, offset=offset, limit=limit, query=query,
                                   count=count, sort=sort, default_sort_field=default_sort_field,
                                   default_sort_order=default_sort_order, search=search,
                                   select=list(set(self.fields.values()).intersection(set(select))),
    ...
    def _execute_data_query(self):
        ...
        with BongosecDBQueryMitreRelationalUse(filters={'target_type': 'software', 'source_type': 'group'},
                                            select=['source_id', 'target_id']) as mitre_relational_query:
            software = mitre_relational_query.run()
        ...
        with BongosecDBQueryMitreReferences(limit=None, filters={'type': 'group'},
                                         select=SELECT_FIELDS_REFERENCES) as mitre_references_query:
            references = mitre_references_query.run()
...
class BongosecDBQueryMitreSoftware(BongosecDBQueryMitre):
    ...
    def _execute_data_query(self):
        ...
        with BongosecDBQueryMitreReferences(limit=None, filters={'type': 'software'},
                                         select=SELECT_FIELDS_REFERENCES) as mitre_references_query:
            references = mitre_references_query.run()
...
def get_mitre_items(mitre_class: callable) -> tuple:
    ...
    mitre_class : callable
        BongosecDBQueryMitre class used to obtain certain MITRE resources.

...
with patch('bongosec.github.iomon.bongosec_uid'):
    with patch('bongosec.github.iomon.bongosec_gid'):
        from bongosec.core.logtest import send_logtest_msg, validate_dummy_logtest
...
@patch('bongosec.core.logtest.BongosecSocketJSON.__init__', return_value=None)
@patch('bongosec.core.logtest.BongosecSocketJSON.send')
@patch('bongosec.core.logtest.BongosecSocketJSON.close')
@patch('bongosec.core.logtest.create_bongosec_socket_message')
def test_send_logtest_msg(create_message_mock, close_mock, send_mock, init_mock, params):
    ...
    """
    with patch('bongosec.core.logtest.BongosecSocketJSON.receive',
...
def test_validate_dummy_logtest(create_message_mock, close_mock, send_mock, init_mock):
    with patch('bongosec.core.logtest.BongosecSocketJSON.receive',
        ...
        with pytest.raises(BongosecError) as err_info:

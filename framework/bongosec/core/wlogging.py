...
class TimeBasedFileRotatingHandler(logging.handlers.TimedRotatingFileHandler):
    """
    Bongosec log rotation. It rotates the log at midnight and sets the appropriate permissions to the new log file.
    """
    ...
    def doRollover(self):
        ...
        # Save rotated file in {BONGOSEC_PATH}/logs/api directory
...
class SizeBasedFileRotatingHandler(logging.handlers.RotatingFileHandler):
    """Bongosec log rotation. It rotates when the logging file size exceeds the maximum number of bytes configured."""
...
class BongosecLogger:
    """
    Define attributes of a Python Bongosec daemon's logger.
    """
    def __init__(self, foreground_mode: bool, log_path: str, debug_level: [int, str], logger_name: str = 'bongosec',
        ...
        log_path : str
            Filepath of the file to send logs to. Relative to the Bongosec installation path.
        ...
        """
        self.log_path = os.path.join(common.BONGOSEC_PATH, log_path)
        self.logger = None

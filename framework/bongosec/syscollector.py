...
from bongosec.core.results import AffectedItemsBongosecResult, merge
from bongosec.core.syscollector import BongosecDBQuerySyscollector, get_valid_fields, Type
...
def get_item_agent(agent_list: list, offset: int = 0, limit: int = common.DATABASE_LIMIT, select: dict = None,
                   ...
                   nested: bool = True, element_type: str = 'os', distinct: bool = False) -> AffectedItemsBongosecResult:
    ...
    for agent in agent_list:
        try:
            ...
            with BongosecDBQuerySyscollector(agent_id=agent, offset=offset, limit=limit, select=select,
                                          search=search,
        ...
        except BongosecResourceNotFound as e:

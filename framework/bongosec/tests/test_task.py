...
with patch('bongosec.github.iomon.bongosec_uid'):
    with patch('bongosec.github.iomon.bongosec_gid'):
        ...
        from bongosec import task, BongosecError
...
@patch('bongosec.core.utils.BongosecDBConnection', return_value=InitWDBSocketMock(sql_schema_file='schema_tasks_test.sql'))
@patch.object(BongosecDBQueryTask, '_final_query', fake_final_query)

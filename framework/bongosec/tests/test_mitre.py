...
with patch('bongosec.core.common.bongosec_uid'):
    with patch('bongosec.core.common.bongosec_gid'):
        ...
        from bongosec.tests.util import get_fake_database_data, RBAC_bypasser, InitWDBSocketMock

        bongosec.rbac.decorators.expose_resources = RBAC_bypasser
        from bongosec import mitre
        from bongosec.core import mitre as core_mitre

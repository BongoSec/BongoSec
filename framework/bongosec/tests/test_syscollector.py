...
with patch('bongosec.core.common.bongosec_uid'):
    with patch('bongosec.core.common.bongosec_gid'):
        ...
        from bongosec import syscollector
        from bongosec.core.results import AffectedItemsBongosecResult
        from bongosec.core.syscollector import Type, get_valid_fields
...
@patch('bongosec.syscollector.get_agents_info', return_value=['000', '001'])
...
def test_get_item_agent(mock_agent_attr, mock_basic_info, mock_agents_info, mock_exists, select, search):
    ...
    with patch('bongosec.core.utils.BongosecDBConnection') as mock_wdb:
        ...
        assert isinstance(results, AffectedItemsBongosecResult)

...
with patch('bongosec.core.common.bongosec_uid'):
    with patch('bongosec.core.common.bongosec_gid'):
        ...
        from bongosec.sca import get_sca_checks, get_sca_list
...
@patch('bongosec.core.sca.BongosecDBQuerySCA.run', return_value={'items': ['test_items'], 'totalItems': 100})
@patch('bongosec.core.sca.BongosecDBQuerySCA.__exit__')
@patch('bongosec.core.sca.BongosecDBQuerySCA.__init__', return_value=None)
@patch('bongosec.core.agent.Agent.get_basic_information')
@patch('bongosec.sca.get_agents_info', return_value=['000'])
def test_get_sca_list(mock_get_agents_info, mock_get_basic_information, mock_BongosecDBQuerySCA__init__,
                      mock_BongosecDBQuerySCA__exit__, mock_BongosecDBQuerySCA_run):
    ...
    mock_BongosecDBQuerySCA__init__.assert_called_once_with(agent_id='000', query='name~value', count=True,
...
@patch('bongosec.sca.get_agents_info', return_value=[])
...
@patch('bongosec.core.sca.BongosecDBQuerySCACheckRelational.run', side_effect=[TEST_SCA_CHECKS_COMPLIANCE,
                                                                         TEST_SCA_CHECKS_RULES])
@patch('bongosec.core.sca.BongosecDBQuerySCACheckRelational.__init__', return_value=None)
@patch('bongosec.core.sca.BongosecDBQuerySCACheck.run', return_value=TEST_SCA_CHECKS)
@patch('bongosec.core.sca.BongosecDBQuerySCACheck.__init__', return_value=None)
@patch('bongosec.core.sca.BongosecDBQuerySCACheckIDs.run', return_value=TEST_SCA_CHECKS_IDS)
@patch('bongosec.core.sca.BongosecDBQuerySCACheckIDs.__init__', return_value=None)
@patch('bongosec.core.sca.BongosecDBQuery.__exit__')
@patch('bongosec.core.agent.Agent.get_basic_information')
@patch('bongosec.sca.get_agents_info', return_value=['000'])
def test_get_sca_checks(mock_get_agents_info, mock_get_basic_information, mock_BongosecDBQuery__exit__,
                        mock_BongosecDBQuerySCACheckIDs__init__, mock_BongosecDBQuerySCACheckIDs_run,
                        mock_BongosecDBQuerySCACheck__init__, mock_BongosecDBQuerySCACheck_run,
                        mock_BongosecDBQuerySCACheckRelational__init__, mock_BongosecDBQuerySCACheckRelational_run):
    ...
    # Assertions
    mock_BongosecDBQuerySCACheckIDs__init__.assert_called_once_with(agent_id=agent_id, offset=offset, limit=limit,
                                                                 filters=filters, search=search, query=q,
                                                                 policy_id=policy_id, sort=sort)
    id_check_list = [item['id'] for item in mock_BongosecDBQuerySCACheckIDs_run.return_value['items']]
    mock_BongosecDBQuerySCACheck__init__.assert_called_once_with(agent_id=agent_id, sort=sort, select=select,
                                                              sca_checks_ids=id_check_list)
    mock_BongosecDBQuerySCACheckRelational__init__.assert_has_calls(
...
@patch('bongosec.core.sca.BongosecDBQueryDistinctSCACheck.run', return_value={'items': ['test_items'], 'totalItems': 100})
@patch('bongosec.core.sca.BongosecDBQueryDistinctSCACheck.__init__', return_value=None)
@patch('bongosec.core.sca.BongosecDBQuery.__exit__')
@patch('bongosec.core.agent.Agent.get_basic_information')
@patch('bongosec.sca.get_agents_info', return_value=['000'])
def test_get_sca_checks_distinct(mock_get_agents_info, mock_get_basic_information, mock_BongosecDBQuery__exit__,
                                 mock_BongosecDBQueryDistinctSCACheck__init__, mock_BongosecDBQueryDistinctSCACheck_run):
    ...
    # Assertions
    mock_BongosecDBQueryDistinctSCACheck__init__.assert_called_once_with(agent_id=agent_id, offset=offset, limit=limit,
                                                                      filters=filters, search=search, query=q,
...
@patch('bongosec.core.sca.BongosecDBQuerySCACheckRelational.run')
@patch('bongosec.core.sca.BongosecDBQuerySCACheckRelational.__init__', return_value=None)
@patch('bongosec.core.sca.BongosecDBQuerySCACheck.run')
@patch('bongosec.core.sca.BongosecDBQuerySCACheck.__init__', return_value=None)
@patch('bongosec.core.sca.BongosecDBQuerySCACheckIDs.run', return_value=TEST_SCA_CHECKS_IDS)
@patch('bongosec.core.sca.BongosecDBQuerySCACheckIDs.__init__', return_value=None)
@patch('bongosec.core.sca.BongosecDBQuery.__exit__')
@patch('bongosec.core.agent.Agent.get_basic_information')
@patch('bongosec.sca.get_agents_info', return_value=['000'])
def test_get_sca_checks_select(mock_get_agents_info, mock_get_basic_information, mock_BongosecDBQuery__exit__,
                               mock_BongosecDBQuerySCACheckIDs__init__, mock_BongosecDBQuerySCACheckIDs_run,
                               mock_BongosecDBQuerySCACheck__init__, mock_BongosecDBQuerySCACheck_run,
                               mock_BongosecDBQuerySCACheckRelational__init__, mock_BongosecDBQuerySCACheckRelational_run,
    ...
    # Assertions
    mock_BongosecDBQuerySCACheckIDs__init__.assert_called_once()
    mock_BongosecDBQuerySCACheck__init__.assert_called_once_with(agent_id=agent_id, select=exp_select_check, sort=None,
                                                              sca_checks_ids=[1, 2, 3])

    # Assert BongosecDBQuerySCACheckRelational__init__ was called only when necessary
    calls = []
    ...
    mock_BongosecDBQuerySCACheckRelational__init__.assert_has_calls(calls, any_order=False)

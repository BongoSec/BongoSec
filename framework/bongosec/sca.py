...
from bongosec.core.sca import (
    BongosecDBQueryDistinctSCACheck, BongosecDBQuerySCA, BongosecDBQuerySCACheck, BongosecDBQuerySCACheckIDs,
    BongosecDBQuerySCACheckRelational, SCA_CHECK_COMPLIANCE_DB_FIELDS, SCA_CHECK_RULES_DB_FIELDS, SCA_CHECK_DB_FIELDS)
...
def get_sca_list(agent_list: list = None, q: str = "", offset: int = 0, limit: int = common.DATABASE_LIMIT,
                 ...
                 filters: dict = None) -> AffectedItemsBongosecResult:
    ...
    AffectedItemsBongosecResult
        Affected items.
    """
    result = AffectedItemsBongosecResult(all_msg='All selected SCA information was returned',
    ...
    if len(agent_list) != 0:
        if agent_list[0] in get_agents_info():
            ...
            with BongosecDBQuerySCA(agent_id=agent_list[0], offset=offset, limit=limit, sort=sort, search=search,
            ...
            result.add_failed_item(id_=agent_list[0], error=BongosecResourceNotFound(1701))
...
def get_sca_checks(policy_id: str = None, agent_list: list = None, q: str = "", offset: int = 0,
                   ...
                   filters: dict = None, distinct: bool = False) -> AffectedItemsBongosecResult:
    ...
    BongosecInternalError(2007)
        If there was an error retrieving data from Bongosec DB.
    ...
    AffectedItemsBongosecResult
        Affected items.
    """
    result = AffectedItemsBongosecResult(all_msg='All selected SCA/policy information was returned',
    ...
    if len(agent_list) != 0:
        if agent_list[0] in get_agents_info():
            ...
            if not distinct:
                ...
                with BongosecDBQuerySCACheckIDs(agent_id=agent_list[0], offset=offset, limit=limit, filters=filters,
                ...
                if id_check_list:
                    ...
                    if not select or select_compliance:
                        with BongosecDBQuerySCACheckRelational(
            ...
            # Workaround for distinct=True
                ...
                with BongosecDBQueryDistinctSCACheck(agent_id=agent_list[0], offset=offset, limit=limit, filters=filters,

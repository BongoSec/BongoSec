...
from bongosec.core import common, mitre
...
def mitre_metadata() -> AffectedItemsBongosecResult:
    ...
    """
    result = AffectedItemsBongosecResult(none_msg='No MITRE metadata information was returned',
                                      all_msg='MITRE metadata information was returned')

    with mitre.BongosecDBQueryMitreMetadata() as db_query:
        data = db_query.run()
...
def mitre_mitigations(filters: dict = None, offset: int = 0, limit: int = common.DATABASE_LIMIT, select: list = None,
    ...
    """
    data = mitre.get_results_with_select(mitre.BongosecDBQueryMitreMitigations, **locals())

    result = AffectedItemsBongosecResult(none_msg='No MITRE mitigations information was returned',
...
def mitre_references(filters: dict = None, offset: int = 0, limit: int = common.DATABASE_LIMIT, select: list = None,
                     sort_by: dict = None, sort_ascending: bool = True, search_text: str = None,
                     complementary_search: bool = False, search_in_fields: list = None,
                     q: str = '') -> AffectedItemsBongosecResult:
    ...
    """
    data = mitre.get_results_with_select(mitre.BongosecDBQueryMitreReferences, **locals())

    result = AffectedItemsBongosecResult(none_msg='No MITRE references information was returned',
...
def mitre_techniques(filters: dict = None, offset: int = 0, limit: int = common.DATABASE_LIMIT, select: list = None,
    ...
    """
    data = mitre.get_results_with_select(mitre.BongosecDBQueryMitreTechniques, **locals())

    result = AffectedItemsBongosecResult(none_msg='No MITRE techniques information was returned',
...
def mitre_tactics(filters: dict = None, offset: int = 0, limit: int = common.DATABASE_LIMIT, select: list = None,
    ...
    """
    data = mitre.get_results_with_select(mitre.BongosecDBQueryMitreTactics, **locals())

    result = AffectedItemsBongosecResult(none_msg='No tactics information was returned',
...
def mitre_groups(filters: dict = None, offset: int = 0, limit: int = common.DATABASE_LIMIT, select: list = None,
    ...
    """
    data = mitre.get_results_with_select(mitre.BongosecDBQueryMitreGroups, **locals())

    result = AffectedItemsBongosecResult(none_msg='No MITRE groups information was returned',
...
def mitre_software(filters: dict = None, offset: int = 0, limit: int = common.DATABASE_LIMIT, select: list = None,
    ...
    """
    data = mitre.get_results_with_select(mitre.BongosecDBQueryMitreSoftware, **locals())

    result = AffectedItemsBongosecResult(none_msg='No MITRE software information was returned',
